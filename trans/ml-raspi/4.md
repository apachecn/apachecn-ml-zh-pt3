...
![$$ {x}_i={i}^{th}\ element\ in\ the\ design\ matrix $$](img/482214_1_En_4_Chapter_TeX_Equa.png)

![$$ {y}_i={i}^{th}\ class\ label $$](img/482214_1_En_4_Chapter_TeX_Equb.png)

评分函数–将输入数据映射到预测类别标签的函数。这可以用一般的方程形式来表示

![$$ f\left( input\ data\right)= predicted\ class\ label $$](img/482214_1_En_4_Chapter_TeX_Equc.png)
...
![$$ f\left(\boldsymbol{X},\boldsymbol{W},\boldsymbol{b}\right)=\boldsymbol{W}\cdotp \boldsymbol{X}\kern0.5em +\boldsymbol{b} $$](img/482214_1_En_4_Chapter_TeX_Equd.png)

其中***W******X***为加权矩阵与输入数据向量的点积。

图 [4-1](#Fig1) 是评分函数的图示。

![img/482214_1_En_4_Fig1_HTML.jpg](img/482214_1_En_4_Fig1_HTML.jpg)
...
![img/482214_1_En_4_Fig2_HTML.jpg](img/482214_1_En_4_Fig2_HTML.jpg)
...
![$$ f\left(\boldsymbol{X},\boldsymbol{W}\right)=\boldsymbol{W}\cdotp \boldsymbol{X} $$](img/482214_1_En_4_Chapter_TeX_Eque.png)
...
![img/482214_1_En_4_Fig3_HTML.jpg](img/482214_1_En_4_Fig3_HTML.jpg)
...
![img/482214_1_En_4_Fig4_HTML.jpg](img/482214_1_En_4_Fig4_HTML.jpg)
...
![$$ \epsilon = abs\left(\hat{y_i}-{y}_i\right) $$](img/482214_1_En_4_Chapter_TeX_Equf.png)

在哪里

*   ε = 错误

*   ![$$ \hat{y_i} $$](img/482214_1_En_4_Chapter_TeX_IEq1.png) =预测类标签
...
![$$ \epsilon =-\Big(y\ast \mathit{\log}(p)+\left(1-y\right)\ast \mathit{\log}\left(1-p\right) $$](img/482214_1_En_4_Chapter_TeX_Equg.png)
 ...
 **![img/482214_1_En_4_Fig5_HTML.jpg](img/482214_1_En_4_Fig5_HTML.jpg)
...
![img/482214_1_En_4_Fig6_HTML.jpg](img/482214_1_En_4_Fig6_HTML.jpg)
...
![img/482214_1_En_4_Fig7_HTML.jpg](img/482214_1_En_4_Fig7_HTML.jpg)
...
![$$ y=\kern0.75em m\ast x+b $$](img/482214_1_En_4_Chapter_TeX_Equh.png)
...
![img/482214_1_En_4_Fig8_HTML.jpg](img/482214_1_En_4_Fig8_HTML.jpg)
...
![$$ {e}_{m,b}=\frac{1}{N}\sum \limits_{i=1}^N{\left({y}_i-\left(m\ast {x}_i+b\right)\right)}^2 $$](img/482214_1_En_4_Chapter_TeX_Equi.png)

现在的重点是开发一个等式，根据 *m* 和 *b* 优化该误差函数，这将产生最小误差。在讨论这个问题之前，说明这个 LR 例子中变量相互作用的性质是有帮助的。图 [4-9](#Fig9) 显示了不同的 m*和 b*值如何影响误差函数的两种观点。

![img/482214_1_En_4_Fig9_HTML.jpg](img/482214_1_En_4_Fig9_HTML.jpg)
...
实现梯度下降法的第一步是对误差函数进行两次偏微分，因为有两个独立变量。这一步与我前面讨论的两个权重示例中的步骤完全相同。偏微分方程实际上比原始误差方程更简单:

![$$ \frac{\partial }{\partial m}=\frac{2}{N}\sum \limits_{i=N}^N-{x}_i\ast \left({y}_i-\left(m\ast {x}_i+b\right)\right) $$](img/482214_1_En_4_Chapter_TeX_Equj.png)

![$$ \frac{\partial }{\partial b}=\frac{2}{N}\sum \limits_{i=N}^N-\left({y}_i-\left(m\ast {x}_i+b\right)\right) $$](img/482214_1_En_4_Chapter_TeX_Equk.png)
...
![img/482214_1_En_4_Fig10_HTML.jpg](img/482214_1_En_4_Fig10_HTML.jpg)
...
![img/482214_1_En_4_Fig11_HTML.jpg](img/482214_1_En_4_Fig11_HTML.jpg)
...
![img/482214_1_En_4_Fig12_HTML.jpg](img/482214_1_En_4_Fig12_HTML.jpg)
...
![img/482214_1_En_4_Fig13_HTML.jpg](img/482214_1_En_4_Fig13_HTML.jpg)
...
![img/482214_1_En_4_Fig14_HTML.jpg](img/482214_1_En_4_Fig14_HTML.jpg)
...
![$$ y=1.3\ast x+0.61 $$](img/482214_1_En_4_Chapter_TeX_Equl.png)
...
![img/482214_1_En_4_Fig15_HTML.jpg](img/482214_1_En_4_Fig15_HTML.jpg)
...
![img/482214_1_En_4_Fig16_HTML.jpg](img/482214_1_En_4_Fig16_HTML.jpg)
...
![$$ g\left({x}_1,{x}_2,{x}_3,\cdots {x}_n\right)=g(X)=\sum \limits_{i=1}^n{x}_i $$](img/482214_1_En_4_Chapter_TeX_Equm.png)

![$$ y=f\left(g(X)\right)=1\kern0.5em if\ g(X)\ge \theta $$](img/482214_1_En_4_Chapter_TeX_Equn.png)

![$$ =0\kern0.5em if\ g(X)&lt;\theta $$](img/482214_1_En_4_Chapter_TeX_Equo.png)
...
![img/482214_1_En_4_Fig17_HTML.jpg](img/482214_1_En_4_Fig17_HTML.jpg)
...
![img/482214_1_En_4_Fig18_HTML.jpg](img/482214_1_En_4_Fig18_HTML.jpg)
...
![img/482214_1_En_4_Fig19_HTML.jpg](img/482214_1_En_4_Fig19_HTML.jpg)
...
![img/482214_1_En_4_Fig20_HTML.jpg](img/482214_1_En_4_Fig20_HTML.jpg)
...
![$$ y=\frac{1}{\left(1+{e}^{-x}\right)} $$](img/482214_1_En_4_Chapter_TeX_Equp.png)
...
![$$ sum\ of\ weighted\ inputs=x={w}_{1,1}\ast in1+{w}_{2,1}\ast in2 $$](img/482214_1_En_4_Chapter_TeX_Equq.png)

![$$ out1=\frac{1}{\left(1+{e}^{-x}\right)} $$](img/482214_1_En_4_Chapter_TeX_Equr.png)

代入表 [4-2](#Tab2) 中的值，得出

![$$ x=0.8\ast 0.8+0.9\ast 0.4=1.0 $$](img/482214_1_En_4_Chapter_TeX_Equs.png)

![$$ out1=\frac{1}{\left(1+{e}^{-1}\right)}=0.731 $$](img/482214_1_En_4_Chapter_TeX_Equt.png)

以类似的方式，计算出 2 的*需要解这些方程:*

![$$ sum\ of\ weighted\ inputs=x={w}_{1,2}\ast in1+{w}_{2,2}\ast in2 $$](img/482214_1_En_4_Chapter_TeX_Equu.png)

![$$ out2=\frac{1}{\left(1+{e}^{-x}\right)} $$](img/482214_1_En_4_Chapter_TeX_Equv.png)

代入表 [4-2](#Tab2) 中的值，得出

![$$ x=0.1\ast 0.8+0.4\ast 0.4=0.24 $$](img/482214_1_En_4_Chapter_TeX_Equw.png)

![$$ out2=\frac{1}{\left(1+{e}^{-0.24}\right)}=0.560 $$](img/482214_1_En_4_Chapter_TeX_Equx.png)

这两个人工神经网络的输出已经通过大量的手工计算确定。现在很明显，试图手动计算更大更复杂的人工神经网络的输出是不现实的。矩阵和矩阵运算将从现在开始使用，因为我已经演示了使用手工计算是多么的乏味。

这个简单示例的输入数据可以表示为一个向量:

![$$ \left\{\begin{array}{c} in1\\ {} in2\end{array}\right\} $$](img/482214_1_En_4_Chapter_TeX_Equy.png)

同样，加权矩阵可以表示为 2×2 矩阵:

![$$ \left\{\begin{array}{c}{w}_{1,1}\ {w}_{1,2}\\ {}{w}_{2,1}\ {w}_{2,2}\end{array}\right\} $$](img/482214_1_En_4_Chapter_TeX_Equz.png)

图 [4-21](#Fig21) 显示了在交互式 Python 会话中使用矩阵运算执行的相同手动计算。

![img/482214_1_En_4_Fig21_HTML.jpg](img/482214_1_En_4_Fig21_HTML.jpg)
...
![img/482214_1_En_4_Fig22_HTML.jpg](img/482214_1_En_4_Fig22_HTML.jpg)
...
![$$ input=\left\{\begin{array}{c}0.8\\ {}0.2\\ {}0.7\end{array}\right\} $$](img/482214_1_En_4_Chapter_TeX_Equaa.png)

输入层和隐藏层之间的加权矩阵( *wtg* <sub>*ih*</sub> )为

![$$ {wtg}_{ih}=\left\{\begin{array}{c}{w}_{1,1}\ {w}_{1,2}\ {w}_{1,3}\\ {}{w}_{2,1}\ {w}_{2,2}\ {w}_{2,3}\\ {}{w}_{3,1}\ {w}_{3,2}\ {w}_{3,3}\end{array}\right\} $$](img/482214_1_En_4_Chapter_TeX_IEq2.png) = ![$$ \left\{\begin{array}{c}0.8\ 0.6\ 0.3\\ {}0.2\ 0.9\ 0.3\\ {}0.2\ 0.5\ 0.8\end{array}\right\} $$](img/482214_1_En_4_Chapter_TeX_IEq3.png)

隐含层和输出层之间的加权矩阵( *wtg* <sub>*ho*</sub> )为

![$$ {wtg}_{ho}=\left\{\begin{array}{c}{w}_{1,1}\ {w}_{1,2}\ {w}_{1,3}\\ {}{w}_{2,1}\ {w}_{2,2}\ {w}_{2,3}\\ {}{w}_{3,1}\ {w}_{3,2}\ {w}_{3,3}\end{array}\right\} $$](img/482214_1_En_4_Chapter_TeX_IEq4.png) = ![$$ \left\{\begin{array}{c}0.4\ 0.8\ 0.4\\ {}0.5\ 0.7\ 0.2\\ {}0.9\ 0.1\ 0.6\end{array}\right\} $$](img/482214_1_En_4_Chapter_TeX_IEq5.png)
...
![img/482214_1_En_4_Fig23_HTML.jpg](img/482214_1_En_4_Fig23_HTML.jpg)
...
![img/482214_1_En_4_Fig24_HTML.jpg](img/482214_1_En_4_Fig24_HTML.jpg)
...
![img/482214_1_En_4_Fig25_HTML.jpg](img/482214_1_En_4_Fig25_HTML.jpg)
...
![$$ \frac{w_{1,1}}{\left({w}_{1,1}+{w}_{2,1}\right)}\kern0.5em \mathrm{and}\ \frac{w_{2,1}}{\left({w}_{1,1}+{w}_{2,1}\right)} $$](img/482214_1_En_4_Chapter_TeX_Equab.png)

类似地，e <sub>2</sub> 的误差为

![$$ \frac{w_{1,2}}{\left({w}_{1,2}+{w}_{2,2}\right)}\kern0.5em \mathrm{and}\ \frac{w_{2,2}}{\left({w}_{1,2}+{w}_{2,2}\right)} $$](img/482214_1_En_4_Chapter_TeX_Equac.png)
...
![img/482214_1_En_4_Fig26_HTML.jpg](img/482214_1_En_4_Fig26_HTML.jpg)
...
![$$ {e}_{1 node1}\ast \frac{w_{1,1}}{\left({w}_{1,1}+{w}_{2,1}\right)}=0.96\ast \frac{2}{\left(2+3\right)}=0.96\ast 0.4=0.38 $$](img/482214_1_En_4_Chapter_TeX_Equad.png)

对于 w <sub>2，1</sub> 线:

![$$ {e}_{1 node2}\ast \frac{w_{2,1}}{\left({w}_{1,1}+{w}_{2,1}\right)}=0.96\ast \frac{3}{\left(2+3\right)}=0.96\ast 0.6=0.58 $$](img/482214_1_En_4_Chapter_TeX_Equae.png)

对于 w <sub>1，2</sub> 线:

![$$ {e}_{2 node1}\ast \frac{w_{1,2}}{\left({w}_{1,2}+{w}_{2,2}\right)}=0.8\ast \frac{2}{\left(2+1\right)}=0.8\ast 0.66=0.53 $$](img/482214_1_En_4_Chapter_TeX_Equaf.png)

对于 w <sub>2，2</sub> 线:

![$$ {e}_{2 node2}\ast \frac{w_{2,2}}{\left({w}_{1,2}+{w}_{2,2}\right)}=0.8\ast \frac{1}{\left(2+1\right)}=0.8\ast 0.33=0.27 $$](img/482214_1_En_4_Chapter_TeX_Equag.png)

每个隐藏节点的总归一化误差值是该节点的单个误差贡献的总和，计算如下:

![$$ {e}_1={e}_{1 node1}\kern0.5em +{e}_{2 node1}=0.38+0.53=0.91 $$](img/482214_1_En_4_Chapter_TeX_Equah.png)

![$$ {e}_2={e}_{1 node2}\kern0.5em +{e}_{2 node2}=0.58+0.27=0.85 $$](img/482214_1_En_4_Chapter_TeX_Equai.png)
...
![$$ {e}_{hidden}=\left\{\begin{array}{c}\frac{w_{1,1}}{\left({w}_{1,1}+{w}_{2,1}\right)}\kern0.5em \frac{w_{1,2}}{\left({w}_{1,1}+{w}_{2,1}\right)}\\ {}\frac{w_{2,1}}{\left({w}_{2,1}+{w}_{2,2}\right)}\kern0.5em \frac{w_{2,2}}{\left({w}_{2,1}+{w}_{2,2}\right)}\end{array}\right\}\ast \left\{\begin{array}{c} in1\\ {} in2\end{array}\right\} $$](img/482214_1_En_4_Chapter_TeX_Equaj.png)

不幸的是，没有简单的方法来输入矩阵中显示的分数。然而，只需考虑分数仅归一化误差贡献，这意味着贡献值的范围仅为 0 到 1.0。通过丢弃分母，仍然可以保持相对误差贡献。移除分母会产生

![$$ {e}_{hidden}=\left\{\begin{array}{c}{w}_{1,1}\kern0.5em {w}_{1,2}\\ {}{w}_{2,1}\kern0.5em {w}_{2,2}\end{array}\right\}\ast \left\{\begin{array}{c} in1\\ {} in2\end{array}\right\} $$](img/482214_1_En_4_Chapter_TeX_Equak.png)
...
![$$ {O}_k=\frac{1}{-\sum \limits_{j=1}^3\left({w}_{j,k}\ast \frac{1}{\sum \limits_{j=1}^3\left({w}_{j,k}\ast {x}_i\right)}\right)} $$](img/482214_1_En_4_Chapter_TeX_Equal.png)

在哪里

![$$ {O}_k= output\ at\ kth\ node $$](img/482214_1_En_4_Chapter_TeX_Equam.png)

![$$ {w}_{j,k}= interconnected\ weights $$](img/482214_1_En_4_Chapter_TeX_Equan.png)

![$$ {x}_i= input\ data $$](img/482214_1_En_4_Chapter_TeX_Equao.png)
...
![img/482214_1_En_4_Fig27_HTML.jpg](img/482214_1_En_4_Fig27_HTML.jpg)
...
![$$ {e}_k={t}_k-{o}_k $$](img/482214_1_En_4_Chapter_TeX_Equap.png)

在哪里

![$$ {t}_k= ground\ truth\ value $$](img/482214_1_En_4_Chapter_TeX_Equaq.png)

![$$ {o}_k= output\ resulting\ from\ {x}_i\ input $$](img/482214_1_En_4_Chapter_TeX_Equar.png)

总误差是每个节点的误差值之和。由此得出的等式是

![$$ {e}_k=\sum \limits_{i=1}^N{\left({t}_k-{o}_k\right)}^2 $$](img/482214_1_En_4_Chapter_TeX_Equas.png)

在哪里

![$$ N= total\ number\ of\ nodes\ in\ ANN $$](img/482214_1_En_4_Chapter_TeX_Equat.png)

误差项也被平方，以确保负误差不会抵消正误差，正如我在梯度下降讨论中提到的那样。

这个误差函数等价于损失函数。这意味着它必须相对于 w <sub>j，k</sub> 求导，以创建用于优化权重的等式。导数形式是

![$$ \frac{\partial e}{\partial {w}_{j,k}}=\frac{\partial }{\partial {w}_{j,k}}\sum \limits_{i=1}^N{\left({t}_k-{o}_k\right)}^2 $$](img/482214_1_En_4_Chapter_TeX_Equau.png)
...
![$$ \frac{\partial e}{\partial {w}_{j,k}}=\frac{\partial }{\partial {w}_{j,k}}{\left({t}_k-{o}_k\right)}^2 $$](img/482214_1_En_4_Chapter_TeX_Equav.png)

进行微分并应用激活函数后的最终方程为

![$$ \frac{\partial e}{\partial {w}_{j,k}}=-\left({t}_k-{o}_k\right)\ast sigmoid\left(\sum \limits_j{w}_{j,k}\ast {o}_j\right)\ast \left(1- sigmoid\left(\sum \limits_j{w}_{j,k}\ast {o}_j\right)\right)\ast {o}_j $$](img/482214_1_En_4_Chapter_TeX_Equaw.png)
...
![$$ \frac{\partial e}{\partial {w}_{i,j}}=-\left({e}_j\ \right)\ast sigmoid\left(\sum \limits_j{w}_{i,j}\ast {o}_i\right)\ast \left(1- sigmoid\left(\sum \limits_j{w}_{i,j}\ast {o}_i\right)\right)\ast {o}_i $$](img/482214_1_En_4_Chapter_TeX_Equax.png)

要显示的唯一剩余等式是显示如何在给定旧权重和梯度下降算法的结果的情况下计算新权重的等式。这个等式是

![$$ new\ {w}_{j,k}= old\ {w}_{j,k}-\alpha \ast \frac{\partial e}{\partial {w}_{j,k}} $$](img/482214_1_En_4_Chapter_TeX_Equay.png)

在哪里

![$$ \alpha = learning\ rate $$](img/482214_1_En_4_Chapter_TeX_Equaz.png)

您应该能够看到学习率参数对人工神经网络在梯度下降过程中的表现有很大的影响。

用矩阵符号表示所有前面的方程在计算上是有效的。以下函数计算将隐藏层节点连接到输出节点的一个链接的梯度下降值:

![$$ g\left({w}_{j,k}\right)=\alpha \ast {e}_k\ast sigmoid\left({o}_k\right)\ast \left(1- sigmoid\left({o}_k\right)\right)\ast {o}_j^T $$](img/482214_1_En_4_Chapter_TeX_Equba.png)

在哪里

![$$ {o}_j^T= transpose\ of\ the\ hidden\ layer\ matrix $$](img/482214_1_En_4_Chapter_TeX_Equbb.png)

以下是三层六节点人工神经网络示例的矩阵:

![$$ \left\{\begin{array}{c}g\left({w}_{1,1}\right)\ g\left({w}_{2,1}\right)\ g\left(\ {w}_{3,1}\right)\\ {}g\left({w}_{1,2}\right)\ g\left({w}_{2,2}\right)\ g\left({w}_{3,2}\right)\end{array}\right\}\ast \left\{\begin{array}{c}{e}_1\ast {sigmoid}_1\ast \Big(1-{sigmoid}_1\\ {}{e}_2\ast {sigmoid}_2\ast \Big(1-{sigmoid}_2\end{array}\right\}\ast \left\{{o}_1\kern0.5em {o}_2\right\} $$](img/482214_1_En_4_Chapter_TeX_Equbc.png)
...
![img/482214_1_En_4_Fig28_HTML.jpg](img/482214_1_En_4_Fig28_HTML.jpg)
...
![$$ \frac{\partial e}{\partial {w}_{j,k}}=-\left({t}_k-{o}_k\right)\ast sigmoid\left(\sum \limits_j{w}_{j,k}\ast {o}_j\right)\ast \left(1- sigmoid\left(\sum \limits_j{w}_{j,k}\ast {o}_j\right)\right)\ast {o}_j $$](img/482214_1_En_4_Chapter_TeX_Equbd.png)

将图中的值代入该方程得到

![$$ \left({t}_k-{o}_k\right)={e}_1=0.96 $$](img/482214_1_En_4_Chapter_TeX_Eqube.png)

![$$ \left(\sum \limits_j{w}_{j,k}\ast {o}_j\right)=\left(2.0\ast 0.6\right)+\left(3.0\ast 0.4\right)=2.4 $$](img/482214_1_En_4_Chapter_TeX_Equbf.png)

![$$ sigmoid=\frac{1}{\left(1+{e}^{-2.4}\right)}=0.9168 $$](img/482214_1_En_4_Chapter_TeX_Equbg.png)

![$$ 1- sigmoid=0.0832 $$](img/482214_1_En_4_Chapter_TeX_Equbh.png)

![$$ {o}_1=0.6 $$](img/482214_1_En_4_Chapter_TeX_Equbi.png)

将前面的因子相乘得到

![$$ -0.96\ast 0.9168\ast 0.0832\ast 0.6=-0.04394 $$](img/482214_1_En_4_Chapter_TeX_Equbj.png)

如果假设学习率为 0.15，则新的权重将为

![$$ new\ {w}_{j,k}= old\ {w}_{j,k}-\alpha \ast \frac{\partial e}{\partial {w}_{j,k}} $$](img/482214_1_En_4_Chapter_TeX_Equbk.png)

![$$ new\ {w}_{j,k}=2.0-0.15\ast \left(-0.04394\right)=2.0+0.0066=2.0066 $$](img/482214_1_En_4_Chapter_TeX_Equbl.png)
...
![img/482214_1_En_4_Fig29_HTML.jpg](img/482214_1_En_4_Fig29_HTML.jpg)
...
如果你用的是 36 个节点的小 ANN，那么均值就是![$$ \frac{1}{\sqrt{36}} $$](img/482214_1_En_4_Chapter_TeX_IEq6.png)或者 0.16667。图 [4-30](#Fig30) 显示了具有该平均值和 2 个标准差的正态概率分布。

![img/482214_1_En_4_Fig30_HTML.jpg](img/482214_1_En_4_Fig30_HTML.jpg)
...
![img/482214_1_En_4_Fig31_HTML.jpg](img/482214_1_En_4_Fig31_HTML.jpg)
...
![img/482214_1_En_4_Fig32_HTML.jpg](img/482214_1_En_4_Fig32_HTML.jpg)
...
![$$ {e}_k={t}_k-{o}_k $$](img/482214_1_En_4_Chapter_TeX_Equbm.png)

输出误差的矩阵符号为

![$$ self. eOutput= self. train- self. oOutput $$](img/482214_1_En_4_Chapter_TeX_Equbn.png)

本例 ANN 的矩阵符号中的隐藏层误差数组为

![$$ hError={\left\{\begin{array}{c}{w}_{1,1}\kern0.5em {w}_{1,2}\kern0.5em {w}_{1,3}\\ {}{w}_{2,1}\kern0.5em {w}_{2,2}\kern0.5em {w}_{2,3}\\ {}{w}_{3,1}\kern0.5em {w}_{3,2}\kern0.5em {w}_{3,3}\end{array}\right\}}^T\ast \left\{\begin{array}{c}{e}_1\\ {}{e}_2\\ {}{e}_3\end{array}\right\} $$](img/482214_1_En_4_Chapter_TeX_Equbo.png)
...
![$$ g\left({w}_{j,k}\right)=\alpha \ast {e}_k\ast sigmoid\left({o}_k\right)\ast \left(1- sigmoid\left({o}_k\right)\right)\ast {o}_j^T $$](img/482214_1_En_4_Chapter_TeX_Equbp.png)
...
![img/482214_1_En_4_Fig33_HTML.png](img/482214_1_En_4_Fig33_HTML.png)
...
![img/482214_1_En_4_Fig34_HTML.jpg](img/482214_1_En_4_Fig34_HTML.jpg)
...
![img/482214_1_En_4_Fig35_HTML.jpg](img/482214_1_En_4_Fig35_HTML.jpg)
