...
![A448827_1_En_8_Fig1_HTML.jpg](A448827_1_En_8_Fig1_HTML.jpg)
...
![A448827_1_En_8_Fig2_HTML.jpg](A448827_1_En_8_Fig2_HTML.jpg)
...
![A448827_1_En_8_Fig3_HTML.jpg](A448827_1_En_8_Fig3_HTML.jpg)
...
![A448827_1_En_8_Fig4_HTML.jpg](A448827_1_En_8_Fig4_HTML.jpg)
...
![A448827_1_En_8_Fig5_HTML.jpg](A448827_1_En_8_Fig5_HTML.jpg)
...
![A448827_1_En_8_Fig6_HTML.jpg](A448827_1_En_8_Fig6_HTML.jpg)
...
![A448827_1_En_8_Fig7_HTML.jpg](A448827_1_En_8_Fig7_HTML.jpg)
...
![A448827_1_En_8_Fig8_HTML.jpg](A448827_1_En_8_Fig8_HTML.jpg)
...
![A448827_1_En_8_Fig9_HTML.jpg](A448827_1_En_8_Fig9_HTML.jpg)
...
![$$ \left\{ ite{m}_1, ite{m}_2, ite{m}_3\to ite{m}_k\right\} $$](A448827_1_En_8_Chapter_Equa.gif)
...
*   Support: Support is defined as number of times an itemset appears in the dataset. Mathematically it is defined as:
    ...
    ![$$ \mathit{\operatorname{supp}}\left(\left\{ beer, diaper\right\}\right)=\frac{\mathrm{number}\kern0.17em \mathrm{of}\kern0.17em \mathrm{transactions}\kern0.17em \mathrm{with}\kern0.17em \mathrm{beer}\kern0.17em \mathrm{and}\kern0.17em \mathrm{diaper}}{total\kern0.17em transactions} $$](A448827_1_En_8_Chapter_Equb.gif)

    In the previous example, `support (beer, diaper) = 1/5 = 0.2`.
*   Confidence: Confidence is a measure of the times the number of times a rule is found to exist in the dataset. For a rule which states ![$$ \left\{ beer\to diaper\right\} $$](A448827_1_En_8_Chapter_IEq1.gif) the confidence is mathematically definedas:

    ![$$ confidence\left(\left\{ beer, diaper\right\}\right)=\frac{\mathit{\operatorname{supp}}\left( beer\kern0.17em and\kern0.17em diaper\right)}{\mathit{\operatorname{supp}}(beer)} $$](A448827_1_En_8_Chapter_Equc.gif)

*   Lift: Lift of the rule is defined as the ratio of observed support to the support expected in the case the elements of the rule were independent. For the previous set of transactions if the rule is defined as ![$$ \left\{X\to \mathrm{Y}\right\} $$](A448827_1_En_8_Chapter_IEq2.gif), then the lift of the rule is defined as:

    ![$$ lift\left(X\to Y\right)=\frac{\mathit{\operatorname{supp}}\left(X\cup Y\right)}{\left(\mathit{\operatorname{supp}}(X)\ast \mathit{\operatorname{supp}}(X)\right)} $$](A448827_1_En_8_Chapter_Equd.gif)

*   频繁项集:频繁项集是支持度大于用户定义的支持度阈值的项集。

#### FP 增长

关联规则挖掘最著名的算法是 Apriori 算法，您可以在网上和标准数据挖掘文献中找到大量的代码和资源。然而，这里我们将使用一个不同的和更有效的算法，FP 增长算法来寻找我们的关联规则。任何关联规则挖掘算法的主要瓶颈是频繁项集的生成。如果事务数据集有 k 个唯一的产品，那么我们可能有![$$ {2}^k $$](A448827_1_En_8_Chapter_IEq3.gif)个可能的项目集。Apriori 算法将首先生成这些项集，然后继续寻找频繁项集。
...
![A448827_1_En_8_Fig10_HTML.jpg](A448827_1_En_8_Fig10_HTML.jpg)
...
![A448827_1_En_8_Fig11_HTML.jpg](A448827_1_En_8_Fig11_HTML.jpg)
...
![A448827_1_En_8_Fig12_HTML.jpg](A448827_1_En_8_Fig12_HTML.jpg)
...
![A448827_1_En_8_Fig13_HTML.jpg](A448827_1_En_8_Fig13_HTML.jpg)
...
![$$ \left\{ yogurt, whole\kern0.17em milk, tropical\kern0.17em fruit\to \mathrm{root}\kern0.17em \mathrm{vegtables}\right\} $$](A448827_1_En_8_Chapter_Eque.gif)
...
![A448827_1_En_8_Fig14_HTML.jpg](A448827_1_En_8_Fig14_HTML.jpg)
