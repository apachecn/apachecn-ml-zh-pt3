...
![A458833_1_En_4_Fig1_HTML.jpg](A458833_1_En_4_Fig1_HTML.jpg)
...
2.  It recalculates the centroid of each cluster by using the following formula:
    ...
    ![$$ {C}_k=\left\{\mathrm{Xn}:\left\Vert Xn-\mu k\right\Vert \le \mathrm{all}\left\Vert Xn-\mu l\right\Vert \right\} $$](A458833_1_En_4_Chapter_Equ1.gif)

    (1)

    ![$$ {\mu}_{\mathrm{k}}=\frac{1}{Ck}{\sum}_{Xn\in Ck} Xn $$](A458833_1_En_4_Chapter_Equ2.gif)
...
点 p 和 q 之间的距离是它们之间的几何线的长度:(![$$ \overline{pq}\Big) $$](A458833_1_En_4_Chapter_IEq2.gif))。这就是所谓的欧几里德距离。
...
![$$ \left\Vert p\right\Vert =\sqrt{{p_1}^2+{p_2}^2+\cdots +{p_n}^2}=\sqrt{p\cdot p}, $$](A458833_1_En_4_Chapter_Equb.gif)
...
![$$ {\displaystyle \begin{array}{l}\left\Vert q-p\right\Vert =\sqrt{\left(q-p\right)\cdot \left(q-p\right)}\\ {}\left\Vert q-p\right\Vert =\sqrt{{\left\Vert p\right\Vert}^2+{\left\Vert q\right\Vert}^2-2p\cdot q}\end{array}} $$](A458833_1_En_4_Chapter_Equc.gif)T2】

一维:

![$$ \sqrt{{\left(x-y\right)}^2}=\mid x-y\mid . $$](A458833_1_En_4_Chapter_Equd.gif)
...
*   骰子骰子系数由下式表示:sim(q，d <sub>j</sub> ) = D(A，B) = ![$$ \frac{\mid A\cap B\mid }{\alpha \mid A\mid +\left(1-\alpha \right)\kern0.125em \mid B\mid } $$](A458833_1_En_4_Chapter_IEq3.gif)还有，![$$ \alpha \in \left[0,1\right] $$](A458833_1_En_4_Chapter_IEq4.gif)并设![$$ \alpha =\frac{1}{2} $$](A458833_1_En_4_Chapter_IEq5.gif)
*   重叠重叠系数的计算如下:Sim(q，d <sub>j</sub> ) = O(A，B) = ![$$ \frac{\mid A\cap B\mid }{\min \kern0.125em \left(|A|,|B|\right)} $$](A458833_1_En_4_Chapter_IEq6.gif)重叠系数是使用最大值运算符而不是最小值来计算的。
*   JAC card JAC card 系数由下式给出:Sim(q，d <sub>j</sub> ) = J(A，B)=![$$ \frac{\mid A\cap B\mid }{\mid A\cup B\mid } $$](A458833_1_En_4_Chapter_IEq7.gif)JAC card 度量表示相关程度。
*   余弦两个向量之间的夹角的余弦由下式给出:Sim(q，d <sub>j</sub> ) = C(A，B) = ![$$ \frac{\mid A\cap B\mid }{\sqrt{\mid A\Big\Vert B\mid }} $$](A458833_1_En_4_Chapter_IEq8.gif)
...
![$$ \mathrm{Dist}\kern0.125em \left({\mathrm{C}}_i,{\mathrm{C}}_j\right)=\frac{\sum_{X\kern0.50em Ci}{\sum}_{Y\ \ \ \kern0.125em {C}_{\mathrm{j}}}\mathrm{dist}\left(X,Y\right)}{\mid {\mathrm{C}}_{\mathrm{i}}\mid \times \mid {\mathrm{C}}_{\mathrm{j}}\mid } $$](A458833_1_En_4_Chapter_Eque.gif)
...
![A458833_1_En_4_Fig2_HTML.jpg](A458833_1_En_4_Fig2_HTML.jpg)
...
![A458833_1_En_4_Fig3_HTML.jpg](A458833_1_En_4_Fig3_HTML.jpg)
...
![$$ \mathrm{Centroid}={\mathrm{C}}_{\mathrm{m}}=\frac{{\sum_{i=1}}^N{t}_{mi}}{\mathrm{N}} $$](A458833_1_En_4_Chapter_IEq9.gif)

![$$ \mathrm{Radius}={\mathrm{R}}_{\mathrm{m}}=\sqrt{\frac{{\sum_{\mathrm{i}=1}}^N{\left({\mathrm{t}}_{\mathrm{m}\mathrm{i}}-{\mathrm{C}}_{\mathrm{m}}\right)}^2}{\mathrm{N}}} $$](A458833_1_En_4_Chapter_Equf.gif)

![$$ \mathrm{Diameter}={\mathrm{D}}_{\mathrm{m}}=\sqrt{\frac{{\sum_{\mathrm{i}=1}}^N{\sum_{\mathrm{j}=1}}^N{\left({\mathrm{t}}_{\mathrm{m}\mathrm{i}}-{\mathrm{C}}_{\mathrm{m}}\right)}^2}{\left(\mathrm{N}\right)\left(\mathrm{N}-1\right)}} $$](A458833_1_En_4_Chapter_Equg.gif)T6】
...
![$$ \mathrm{P}\left(\mathrm{A},\mathrm{B}\right)=\frac{\mid A\cap B\mid }{\mid A\mid } $$](A458833_1_En_4_Chapter_Equ3.gif)

和

![$$ \mathrm{R}\left(\mathrm{A},\mathrm{B}\right)=\frac{\mid A\cap B\mid }{\mid B\mid } $$](A458833_1_En_4_Chapter_Equh.gif)T5】