...
使用酉算子![$$ {e}^{-i\overset{\sim }{A}t} $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq11.png)应用量子相位估计。由于![$$ \overset{\sim }{A} $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq12.png)具有由![$$ \overset{\sim }{A}=\sum \limits_i{\lambda}_i\mid {u}_i\left\rangle \right\langle {u}_i\mid $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq13.png)给出的频谱分解，因此![$$ {e}^{i\overset{\sim }{A}t} $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq14.png)的频谱分解由以下给出:
...
![$$ \left|{\psi}_6\right\rangle =C\times \frac{2\pi }{t{\left\langle b|b\right\rangle}^{1/2}}\sum \limits_j\frac{b_j}{\lambda_j\ }\left|{u}_j\right\rangle $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ22.png)
...
![$$ \left[\begin{array}{c}{x}_1^T\to \\ {}{x}_2^T\to \\ {}..\\ {}{x}_i^T\to \\ {}..\\ {}{x}_{M\to}^T\end{array}\right]\ \uptheta =\left[\begin{array}{c}\hat{y_1}\ \\ {}\hat{y_2}\ \\ {}..\\ {}\hat{y_i}\\ {}..\\ {}\hat{y_M}\end{array}\right] $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ28.png)
...
在交换测试实现中，我们测试通过在∣00⟩初始化的两个量子位上应用哈达玛变换而获得的相等叠加状态![$$ \left|a\right\rangle =\frac{1}{2}\left(\left|00\right\rangle +\left|01\right\rangle +\left|10\right\rangle +\mid 11\right\rangle $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq38.png)和状态| * b * ⟩ = ∣00⟩.之间的点积交换测试电路给出`0.53`的点积，接近预期值`0.5`。还报告了从测量得到的副量子位为 1 的概率，以供参考。
...
1.  对于每个数据点*x*<sub>*I*</sub>∈*ℝ*<sup>*n*</sup>由经典存储的其量值![$$ {\left\Vert \overrightarrow{x_i}{x}_i\right\Vert}_2 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq64.png)表示，并且由存储为量子状态的其单位范数∣*x*<sub>*I*</sub>⟩表示，我们使用量子欧几里德距离计算例程计算其与每个 *k* 簇质心的距离，如下所示:
    ...
    ![$$ d\left(i,j\right)={\left\Vert \left({x}_i-{u}_j\right)\right\Vert}^2=4Z\left(P\left(|0\Big\rangle \right)-0.5\right)\kern1.25em j\in \left\{1,2,..k\right\} $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ45.png)
...
![../images/495362_1_En_5_Chapter/495362_1_En_5_Fig4_HTML.jpg](../images/495362_1_En_5_Chapter/495362_1_En_5_Fig4_HTML.jpg)
...
![$$ {x}_i\to {x}_i-\sum \limits_{i=1}^M{x}_i $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ50.png)

(5-51)

一旦均值居中，我们将每个数据点*x*T2】T3It5】除以它们的*l*t8】2 范数| |*x*t13】It15】| |<sub>2</sub>使得每个都具有单位范数，因此可以被视为量子态∣*x*t20】t21】It23】⟩.

![$$ \left|{x}_i\right\rangle \to {\left\Vert {x}_i\right\Vert}^{-1}{x}_i $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ51.png)
...
![$$ {\rho}_i=\mid {x}_i\left\rangle \right\langle {x}_i\mid $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ52.png)

(5-53)

现在对于可以以相等经典概率存在于任何一个 *M* 态的混合量子系统，密度矩阵由下面给出:

![$$ \rho =\frac{1}{M}\sum \limits_{i=1}^M\mid {x}_i\left\rangle \right\langle {x}_i\mid $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ53.png)

(5-54)

*N* 维状态向量| *x* <sub>*i*</sub> ⟩可以用正交基| *k* ⟩表示其中 *k* ∈ {0，1，2，..*N*—1 }，如下:

![$$ \left|{x}_i\right\rangle =\sum \limits_{i=0}^{N-1}{x}_{ik}\mid k\Big\rangle $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ54.png)

(5-55)

将状态向量∣*x*T2】T3】It5】⟩的表达式从方程 [5-55](#Equ55) 代入方程 [5-54](#Equ53) ，我们得到如下:

![$$ \rho =\frac{1}{M}\sum \limits_{i=1}^M\sum \limits_{k=0}^{N-1}{x}_{im}^{\ast }\ {x}_{ik}\left|m\right\rangle \left\langle k\right| $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ55.png)

(5-56)

我们通常在主成分分析中处理实数据，因此 *x* <sub>*im*</sub> 等于它的复共轭![$$ {x}_{im}^{\ast }, $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq71.png)因此我们可以将方程 [5-56](#Equ56) 重写如下:

![$$ \rho =\frac{1}{M}\sum \limits_{i=1}^M\sum \limits_{m=0}^{N-1}\sum \limits_{k=0}^{N-1}{x}_{im}{x}_{ik}\left|m\right\rangle \left\langle k\right| $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ56.png)

(5-57)

由于数据已经以零为中心，等式 [5-57](#Equ57) 中的 *ρ* 的表达式只不过是协方差矩阵，其中对应于行 *m* 和列 *k* 的条目由外积| *m* ⟩⟨ *k* 给出。因此，方程 [5-57](#Equ57) 中的 *ρ* 可以写成:

![$$ \rho =\frac{1}{M}\sum \limits_{i=1}^M\left[\begin{array}{ccc}\sum \limits_i{x}_{i0}^2&amp; {\sum}_i{x}_{i0}{x}_{i1}&amp; \dots \kern0.5em {\sum}_i{x}_{i0}{x}_{i\left(N-1\right)}\\ {}{\sum}_i{x}_{i1}{x}_{i0}&amp; \sum \limits_i{x}_{i1}^2&amp; \dots \kern0.75em {\sum}_i{x}_{i1}{x}_{i\left(N-1\right)}\\ {}\dots \kern0.5em &amp; \dots &amp; \dots \\ {}\kern0.5em {\sum}_i{x}_{i\left(N-1\right)}{x}_{i0}&amp; {\sum}_i{x}_{i\left(N-1\right)}{x}_{i1}&amp; \dots \kern1em \sum \limits_i{x}_{i\left(N-1\right)}^2\end{array}\right] $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ57.png)
...
我们可以智能地使用量子相位估计算法来执行幺正算符的谱分解，并最终执行密度矩阵。对于量子相位估计，我们的酉算符是=*e*<sup>—*Iρt*</sup>。通常，在量子相位估计中，给定一个幺正算符和它的一个特征向量状态，我们计算它相应的特征值。由于在这个问题中，我们需要找到特征值及其相应的特征向量，我们不能从一个已知的特征向量状态开始。如果密度矩阵 *ρ* 具有由![$$ \rho =\sum \limits_j{\lambda}_j\mid {\phi}_j\left\rangle \right\langle {\phi}_j\mid, $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq72.png)给出的谱分解，那么酉算子具有由以下给出的谱分解:

![$$ {e}^{- i\rho t}=\sum \limits_{J=1}^M{e}^{-{i\lambda}_jt}\mid {\phi}_j\left\rangle \left\langle {\phi}_j|=\sum \limits_{J=1}^M{e}^{-2\pi i\left({\lambda}_jt/2\pi \right)}|{\phi}_j\right\rangle \right\langle {\phi}_j\mid $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ58.png)

(5-59)

如果我们使用一个*n*-量子位工作寄存器进行量子相位估计，那么具有任意本征态的量子相位估计| *ϕ* <sub>*j*</sub> ⟩将为我们获取本征相位![$$ \overset{\sim }{\lambda_j}=\left({\lambda}_jt/2\pi \right) $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq73.png)，如下所示:

![$$ QPE:{{\left|0\right\rangle}_W}^{\otimes n}\left|{\phi}_j\right\rangle \to \left\rangle {\left|{\overset{\sim }{\lambda}}_j\right\rangle}_W\mid {\phi}_j\right\rangle $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ59.png)

(5-60)

现在既然我们不知道本征值，我们可以从一个数据点状态∣*x*T2】T3】It5】⟩开始，它可以表示为本征值状态的叠加![$$ \left|{x}_i\right\rangle =\sum \limits_j{x}_{ij}\mid {\phi}_j\Big\rangle . $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq74.png)

![$$ {x}_{ij}=\left\langle {\phi}_j|{x}_i\right\rangle $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ60.png)

(5-61)

因此，对数据点状态| *x* <sub>*i*</sub> ⟩的量子相位估计可以表示如下:

![$$ QPE:{{\left|0\right\rangle}_W}^{\otimes n}\left|{x}_i\kern0.5em \right\rangle \to \left|{y}_i\right\rangle =\sum \limits_{j=1}^M{x}_{ij}{\left|\overset{\sim }{\lambda_j}\right\rangle}_W\mid {\phi}_j\Big\rangle $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ61.png)
...
现在我们已经有了密度矩阵∣*x*T2】T3】It5】⟩⟨*x*T9】It11】∣对于数据点状态∣*x*t14】t15】It17】⟩的量子相位估计结果，我们可以将其扩展到所有数据点的混合状态![$$ \rho =\frac{1}{M}\sum \limits_{i=1}^M\mid {x}_i\left\rangle \right\langle {x}_i\mid $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq75.png)。这里同样可以表述为:

![$$ QPE:\rho \to \eta =\sum \limits_{i=1}^M\sum \limits_{j=1}^M{\left|{x}_{ij}\right|}^2{\left|\overset{\sim }{\lambda_j}\right\rangle}_W\left\langle {\overset{\sim }{\lambda}}_{jW}\otimes |{\phi}_j\right\rangle \Big\langle {\phi}_j\mid $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ63.png)

(5-64)

现在让我们看看能否简化方程 [5-64](#Equ64) 中的表达式。我们有*x*<sub>*ij*</sub>=⟨*ϕ*<sub>*j*</sub>|*x*<sub>*I*</sub>⟩因而有如下:

![$$ {\left|{x}_{ij}\right|}^2=\left\langle {\phi}_j|{x}_i\right\rangle \left\langle {x}_i|{\phi}_j\right\rangle $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ64.png)

(5-65)

取|*x*<sub>T3】ij</sub>|<sup>2</sup>以上这 M 个数据点，我们有如下:

![$$ \frac{1}{M}\sum \limits_{i=1}^M{\left|{x}_{ij}\right|}^2=\frac{1}{M}\sum \limits_{i=1}^M\left\langle {\phi}_j|{x}_i\right\rangle \left\langle {x}_i|{\phi}_j\right\rangle $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equr.png)

![$$ =\Big\langle {\phi}_j\left|\left(\frac{1}{M}\sum \limits_{i=1}^M\left|{x}_i\right\rangle \left\langle {x}_i\right|\right){\phi}_j\right\rangle $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equs.png)

![$$ =\left\langle {\phi}_j\left|\rho \right|{\phi}_j\right\rangle $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ65.png)

(5-66)

既然∣*<sub>*j*</sub>⟩是 *ρ* 的特征向量，我们就有了⟨*ϕ*<sub>*j*</sub>|*ρ*|*ϕ*<sub>*j*</sub>⟩=*λ*<sub>*j*</sub>。这将方程式 [5-66](#Equ66) 简化为如下:*

*![$$ \frac{1}{M}\sum \limits_{i=1}^M{\left|{x}_{ij}\right|}^2={\lambda}_j $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ66.png)*

*(5-67)

将方程 [5-67](#Equ67) 中的![$$ \frac{1}{M}\sum \limits_{i=1}^M{\left|{x}_{ij}\right|}^2 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq76.png)代入方程 [5-64](#Equ64) ，密度矩阵 *ρ* 的量子相位估计简化为:

![$$ QPE:\rho \to \eta =\sum \limits_{j=1}^M{\lambda}_j{\left|\overset{\sim }{\lambda_j}\right\rangle}_W\left\langle {\overset{\sim }{\lambda}}_{jW}\otimes |{\phi}_j\right\rangle \Big\langle {\phi}_j\mid $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ67.png)
...
![$$ {s}_{ij}=\left\langle {\phi}_j|{x}_i\right\rangle $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ68.png)

(5-69)

基于我们想要保留的主成分数 *k* ， *x* <sub>*i*</sub> ⟩状态向量可以表示为由如下 *k* 主成分组成的基:

![$$ \left|{x}_i\right\rangle ={\left[{s}_{i1}\ {s}_{i2}\dots ..{s}_{ik}\right]}^T $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ69.png)
...
![../images/495362_1_En_5_Chapter/495362_1_En_5_Fig5_HTML.jpg](../images/495362_1_En_5_Chapter/495362_1_En_5_Fig5_HTML.jpg)

图 5-5

支持向量机超平面

假设我们的超平面方向由垂直于超平面的参数向量![$$ \overrightarrow{\theta}\in {\mathbb{R}}^n $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq77.png)和定义超平面与原点的距离的偏差 *b* 定义，位于超平面上的特征向量![$$ \overrightarrow{x}\in {\mathbb{R}}^n $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq78.png)可以定义如下:

![$$ {\theta}^Tx=b\to {\theta}^Tx-b=0 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ70.png)

(5-71)

在支持向量机中，我们试图以这样一种方式建立超平面，使得一类数据点，比如说，具有标签 *y* = 1，满足以下关系:

![$$ {\theta}^Tx-b\ge 1\kern0.5em ;\kern0.75em \forall y=1 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equt.png)

![$$ \to y\left({\theta}^Tx-b\right)\ge 1 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ71.png)

(5-72)

具有标签*y*= 1 的另一类数据点应满足以下关系:

![$$ {\theta}^Tx-b\le 1;\forall y=-1 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equu.png)

![$$ \to y\left({\theta}^Tx-b\right)\ge 1 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ72.png)
...
**![$$ {\theta}^T{x}^{+}-b=\kern0.5em 1 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equv.png)**

**![$$ {\theta}^T{x}^{-}-b=-1 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ73.png)**

**(5-74)**

人们可以将方程 [5-53](#Equ33) 中的两个方程相减，得到如下:

![$$ {\theta}^T\left({x}^{+}-{x}^{-}\right)=2 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equw.png)

![$$ \to \left\Vert {\theta}^T\left({x}^{+}-{x}^{-}\right)\right\Vert =2 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equx.png)

![$$ \to \left\Vert \theta \right\Vert \left\Vert {x}^{+}-{x}^{-}\right\Vert =2 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equy.png)

![$$ \to {\left\Vert {x}^{+}-{x}^{-}\right\Vert}_2=\frac{2}{{\left\Vert \theta \right\Vert}_2} $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ74.png)
...
![$$ {y}_i\left({\theta}^T{x}_i-b\right)\ge 1 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equz.png)

![$$ \to {y}_i\left({\theta}^T{x}_i-b\right)-1\ge 0 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ75.png)

(5-76)

所以，最优化问题可以写成:

![$$ \underset{\theta }{\min}\frac{1}{2}{\left\Vert \theta \right\Vert}_2^2 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ76.png)

(5-77)

它受到以下约束:

![$$ {y}_i\left({\theta}^T{x}_i-b\right)-1\ge 0;\forall i=\left\{1,2,\dots M\right\} $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equaa.png)
...
![$$ L\left(\theta, b,\alpha \right)=\kern0.5em \frac{1}{2}{\left\Vert \theta \right\Vert}_2^2-\sum \limits_{i=1}^M{\alpha}_i\left({y}_i\left({\theta}^T{x}_i-b\right)-1\right) $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ77.png)
...
![$$ {\theta}^{\ast },{b}^{\ast },{\alpha}^{\ast }=\underset{\theta, b}{\underbrace{argmin}}\ \underset{\alpha }{\underbrace{argmax}}\ L\left(\theta, b,\alpha \right) $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ78.png)

(5-79)

我们通常分两步进行优化。首先，我们相对于 *θ* 和 *b* 最小化目标，并将导出的 *θ* 和 *b* 的值代入方程 [5-79](#Equ79) 。为此，我们取 *L* ( *θ* ， *b* ， *α* )相对于 *θ* 和 *b* 的梯度，并将其设置为零。物镜相对于 *θ* 的梯度如下:

![$$ {\nabla}_{\theta }L\left(\theta, b,\alpha \right)=\theta -\sum \limits_{i=1}^M{\alpha}_i{y}_i{x}_i=0 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equab.png)

![$$ \to \theta =\sum \limits_{i=1}^M{\alpha}_i{y}_i{x}_i $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ79.png)

(5-80)

同样，我们将目标相对于 *b* 的导数设为零，得到如下:

![$$ \frac{\partial L\left(\theta, b,\alpha \right)}{\partial b}=\sum \limits_{i=1}^M{\alpha}_i{y}_i=0 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ80.png)

(5-81)

从方程 [5-80](#Equ80) 中代入 *θ* 的值，我们得到如下:

![$$ L\left(\theta, b,\alpha \right)=\frac{1}{2}\sum \limits_{i=1}^M{\alpha}_i{y}_i{x}_i^T\sum \limits_{j=1}^M{\alpha}_j{y}_j{x}_j-\sum \limits_{i=1}^M{\alpha}_i{y}_i{\theta}^T{x}_i+\sum \limits_{i=1}^M{\alpha}_i{y}_ib-\sum \limits_{i=1}^M{\alpha}_i $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equac.png)

![$$ =\frac{1}{2}\sum \limits_{i=1}^M\sum \limits_{j=1}^M{\alpha}_i{\alpha}_j{y}_i{y}_j{x}_i^T{x}_j-\sum \limits_{i=1}^M{\alpha}_i{y}_i\sum \limits_{j=1}^M{\alpha}_j{y}_j{x}_j^T{x}_i+\sum \limits_{i=1}^M{\alpha}_i{y}_ib-\sum \limits_{i=1}^M{\alpha}_i $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equad.png)

![$$ =\frac{1}{2}\sum \limits_{i=1}^M\sum \limits_{j=1}^M{\alpha}_i{\alpha}_j{y}_i{y}_j{x}_i^T{x}_j-\sum \limits_{i=1}^M\sum \limits_{j=1}^M{\alpha}_i{\alpha}_j{y}_i{y}_j{x}_i^T{x}_j+\sum \limits_{i=1}^M{\alpha}_i{y}_ib-\sum \limits_{i=1}^M{\alpha}_i $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ81.png)

(5-82)

根据等式 [5-81](#Equ81) ，等式 [5-82](#Equ82) 中的第三项为零，因此我们可以将目标简化为:

![$$ L\left(\alpha \right)=\sum \limits_{i=1}^M{\alpha}_i-\frac{1}{2}\sum \limits_{i=1}^M\sum \limits_{j=1}^M{\alpha}_i{\alpha}_j{y}_i{y}_j\left({x}_i^T{x}_j\right) $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ82.png)

(5-83)

现在我们的目标仅仅是拉格朗日乘数 *α* <sub>*i*</sub> ，因此我们进入优化的第二阶段，我们需要解决这里定义的对偶优化问题:

![$$ \underset{\alpha }{\max }L\left(\alpha \right)=\sum \limits_{i=1}^M{\alpha}_i-\frac{1}{2}\sum \limits_{i=1}^M\sum \limits_{j=1}^M{\alpha}_i{\alpha}_j{y}_i{y}_j\left({x}_i^T{x}_j\right) $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ83.png)

(5-84)

它受到这些约束:

![$$ {\alpha}_i\ge 0;\forall i=1,2,\dots M $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equae.png)

![$$ \sum \limits_{i=1}^M{\alpha}_i{y}_i=0 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equaf.png)
...
![$$ k\left({x}_i,{x}_j\right)=\phi {\left({x}_i\right)}^T\phi \left({x}_j\right)={e}^{-\frac{{\left\Vert {x}_i-{x}_j\right\Vert}_2^2}{\sigma }} $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ84.png)
...
![$$ \underset{\alpha }{\min }L\left(\alpha \right)=\frac{1}{2}\sum \limits_{i=1}^M\sum \limits_{j=1}^M{\alpha}_i{\alpha}_j{y}_i{y}_jk\left({x}_i,{x}_j\right)-\sum \limits_{i=1}^M{\alpha}_i $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ85.png)
...
![$$ {f}_{\theta, b}(x)={\theta}^Tx-b $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ86.png)

(5-87)

从方程式 [5-80](#Equ80) ，我们有![$$ \theta =\sum \limits_{i=1}^M{\alpha}_i{y}_i{x}_i $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq79.png)。将其代入方程 [5-87](#Equ87) ，我们得到更新后的决策边界如下:

![$$ {f}_{\alpha, b}(x)=\sum \limits_{i=1}^M{\alpha}_i{y}_i{x}_i^Tx-b $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ87.png)

(5-88)

与训练目标非常相似，用于预测的决策边界取决于预测的数据点 *x* 和训练中的数据点*x*<sub>T5】I</sub>的点积。因此，我们可以通过用核函数替换点积来概括决策边界，如下所示:

![$$ {f}_{\alpha, b}(x)=\sum \limits_{i=1}^M{\alpha}_i{y}_ik\left({x}_ix\right)-b $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ88.png)
...
执行函数 *L* ( *α* )并为最优的*α*<sup>∫</sup>输出 1 的 oracle *O* 需要被实现为这个量子 SVM 公式的一部分。Grover 算法的输入是所有可能的拉格朗日乘子![$$ \left|\psi \right\rangle =\frac{1}{2^M}\sum \limits_{k=1}^{2^M}\mid {\alpha}_k\Big\rangle $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq80.png)的相等叠加，期望输出是大概率最优的拉格朗日乘子∣*α*t13】∫⟩。

Grover 算法为方程 [5-64](#Equ64) 中的目标函数提供了一个全局最优解，并且将时间复杂度从 *O* ( *N* )降低到![$$ O\left(\sqrt{N}\ \right) $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq81.png)。然而，实现这样的量子 SVM 算法确实有其自身的局限性。注意，构建一个实现具有复杂内核的目标函数 *L* ( *α* )的 oracle 可能是一项非常具有挑战性的任务。
...
![$$ {y}_i\left({\theta}^T{x}_i-b\right)=1-{\mathrm{e}}_{\mathrm{i}} $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ89.png)

(5-90)

作为优化的一部分，我们最小化每个数据点的误差的平方和![$$ {e}_i^2 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq82.png)作为正则项，以及与最大化超平面之间的距离相关联的成本目标![$$ \frac{1}{2}{\left\Vert \theta \right\Vert}^2 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq83.png)(*θ*<sup>T5】T</sup>*x*<sub>*I*</sub>-*b*)= 1。对于每个数据点，优化问题还应遵守等式 [5-90](#Equ90) 中的等式约束。最小二乘 SVM 的总体目标可以写成:

![$$ \underset{\theta }{\min }L\left(\theta, b\right)=\kern0.5em \frac{1}{2}{\theta}^T\theta +\frac{\gamma }{2}\sum \limits_{i=1}^M{e}_i^2 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equag.png)

它受制于

![$$ {y}_i\left({\theta}^T{x}_i-b\right)=1-{\mathrm{e}}_{\mathrm{i}}\kern0.5em ;\forall i\in 1,2,\dots M\Big\} $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ90.png)

(5-91)

在 SVM，二进制类被标记为+1 或-1，因此称为![$$ {y}_i^2=1 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_IEq84.png)。将等式 [5-91](#Equ91) 两边的 *y* <sub>* i *</sub> 相乘，我们得到如下:

![$$ {y}_i^2\left({\theta}^T{x}_i-b\right)={\mathrm{y}}_{\mathrm{i}}-{\mathrm{y}}_{\mathrm{i}}{\mathrm{e}}_{\mathrm{i}} $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equah.png)

![$$ \to {\theta}^T{x}_i-b={y}_i-{y}_i{e}_i $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equai.png)

![$$ \to {y}_i{e}_i={y}_i-\left({\theta}^T{x}_i-b\right) $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ91.png)
...
*![$$ {y}_i-\left({\theta}^T{x}_i-b\right)={e}_i $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ92.png)*

*(5-93)*

因此，最小二乘 SVM 中的总体目标可以写成如下:

![$$ \underset{\theta }{\min }L\left(\theta, b\right)=\kern0.5em \frac{1}{2}{\theta}^T\theta +\frac{\gamma }{2}\sum \limits_{i=1}^M{e}_i^2 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equaj.png)

它受到以下约束:

![$$ {y}_i-\kern0.5em \left({\theta}^T{x}_i-b\right)={\mathrm{e}}_{\mathrm{i}};\forall i\in 1,2,\dots M\Big\} $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ93.png)

(5-94)

每个数据点的约束( *x* <sub>*i*</sub> ， *y* <sub>*i*</sub> )可以使用拉格朗日乘数 *α* <sub>*i*</sub> 在现有目标中组合，如下所示:

![$$ L\left(\theta, b,\alpha, e\right)=\frac{1}{2}{\theta}^T\theta +\frac{\gamma }{2}\sum \limits_{i=1}^M{e}_i^2-\sum \limits_{i=1}^M{\alpha}_i\left[\left({\theta}^T{x}_i-b\right)-{y}_i+{e}_i\right] $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ94.png)

(5-95)

最优性的条件如下:

![$$ {\nabla}_{\theta }L=\theta -\sum \limits_{i=1}^M{\alpha}_i{x}_i=0\to \theta =\sum \limits_{i=1}^M{\alpha}_i{x}_i $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equak.png)

![$$ \frac{\partial L}{\partial b}=\sum \limits_{i=1}^M{\alpha}_i=0 $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equal.png)

![$$ {\nabla}_eL=\gamma e-\alpha =0\to \alpha =\gamma e $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equam.png)

![$$ \frac{\partial L}{\partial {\alpha}_i}=\left({\theta}^T{x}_i-b\right)-{y}_i+{e}_i=0;\forall i\in \left\{1,2,\dots \dots M\right\} $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ95.png)

(5-96)

我们可以通过求解与最优性有关的前四组方程(见方程 [5-96](#Equ96) )来去除 *θ* 和误差松弛项*e*<sub>T5】I</sub>。这留给我们一个线性方程组，表示如下:

![$$ \left[\begin{array}{cc}0&amp; {1}^T\\ {}1&amp; K+{\gamma}^{-1}\end{array}\right]\left[\begin{array}{c}-b\\ {}\alpha \end{array}\right]=\left[\begin{array}{c}0\\ {}Y\end{array}\right] $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ96.png)
...
![$$ {f}_{\alpha, b}(x)=\sum \limits_{i=1}^M{\alpha}_i{y}_ik\left({x}_ix\right)-b $$](../images/495362_1_En_5_Chapter/495362_1_En_5_Chapter_TeX_Equ97.png)
