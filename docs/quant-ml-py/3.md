...
![$$ \left|{\psi}_3\right\rangle ={H}^{\otimes n}\left|{\psi}_2\right\rangle =\frac{1}{2^n}\sum \limits_{z=0}^{2^n-1}\sum \limits_{x=0}^{2^n-1\ }{\left(-1\right)}^{f(x)+x\odot z}\left|z\right\rangle \otimes \frac{1}{\surd 2}\left(|0\Big\rangle -|1\Big\rangle \right) $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equ22.png)
...
![$$ \frac{1}{2^{\frac{n}{2}+\frac{1}{2}}}\left[{\left(-1\right)}^{x_1\odot z}+{\left(-1\right)}^{x_2\odot z}\ \right] $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equ42.png)
...
![$$ {U}_f\left|k\right\rangle ={\left(-\right)}^{f(k)}\left|k\right\rangle =-{1}^1\left|k\right\rangle =-\mid k\Big\rangle $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equ47.png)

(3-48)

现在我们有了一些关于神谕的信息，让我们看看格罗弗算法的步骤:

1.  基于数据库中项目的数量*n*= 2<sup>= T3】n</sup>，我们使用哈达玛变换，即![$$ \left|{\psi}_{in}\right\rangle ={H}^{\otimes n}{\left|0\right\rangle}^n=\frac{1}{\sqrt{N}}\ {\sum}_0^{N-1}\mid x\Big\rangle $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq28.png)，定义了初始化为|0⟩ <sup> ⊗ *n* 的 *n* 量子位上的相等叠加态。我们还将一个在∣0⟩初始化的目标量子位置于负态，我们用它来实现*相位反冲技巧*。这给了我们输入和目标量子位的组合状态| * ψ * <sub> 1 </sub> ⟩如下:</sup>

![$$ \left|{\psi}_1\right\rangle =\frac{1}{\sqrt{N}}\ {\sum}_0^{N-1}\mid x\Big\rangle \otimes \frac{1}{\sqrt{2}}\left(\left|0\right\rangle -|1\Big\rangle \right) $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equ48.png)
 ...
 *![$$ \left|{\psi}_2\right\rangle ={U}_f\left|{\psi}_1\right\rangle =\frac{1}{\sqrt{N}}\ {\sum}_0^{N-1}\left|x\right\rangle {\left(-\right)}^{f(x)}\otimes \frac{1}{\sqrt{2}}\left(\left|0\right\rangle -|1\Big\rangle \right) $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equ49.png)
...
![../images/495362_1_En_3_Chapter/495362_1_En_3_Fig6_HTML.jpg](../images/495362_1_En_3_Chapter/495362_1_En_3_Fig6_HTML.jpg)

图 3-6

Grover 算法的几何解释

1.  我们可以把相等的叠加态![$$ \left|{\psi}_{in}\right\rangle =\frac{1}{\sqrt{N}}\ {\sum}_0^{N-1}\mid x\Big\rangle $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq29.png)想象成两个相互正交的向量的线性组合:我们用∣ * k * ⟩和向量∣ * c * ⟩来表示的被搜索的*或*获胜项*这是通过从相等的叠加态| t11】ψ*t13】⟩.中去除向量∣ * k * ⟩的分量而获得的单位向量图 [3-6(a)](#Fig6) 对此进行了说明。

这就允许我们把| *ψ* <sub>*中的*</sub> ⟩中的两个向量∣ *k* ⟩和| *c* ⟩(见图 [3-6](#Fig6) (a))写成如下:

![$$ \left|{\psi}_{in}\right\rangle = sin\theta \left|k\right\rangle + cos\theta \mid c\Big\rangle $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equ50.png)

(3-51)

在等式 [3-51](#Equ50) 中，我们有 *cosθ* = ![$$ \frac{1}{\sqrt{N}} $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq30.png)和![$$ sin\theta =\frac{\surd \left(N-1\right)}{\surd N}. $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq31.png)

1.  现在，一旦我们将甲骨文变换 *U* <sub>*f*</sub> 应用于 ⟩中的状态∣ *ψ* <sub>*，与获胜者项目状态∣ *k* ⟩对应的相位将乘以 1，因此输出状态∣*ψ*<sub>*mid*</sub>⟩可以表示如下:*</sub>

![$$ \left|{\psi}_{mid}\right\rangle ={U}_f\left|{\psi}_{in}\right\rangle =- sin\theta \left|k\right\rangle + cos\theta \mid c\Big\rangle $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equ51.png)

(3-52)

所以，酉甲骨文变换 *U* <sub>*f*</sub> 基本上具有应用关于矢量∣ *c* ⟩的反射的效果，如图 [3-6(b)](#Fig6) 所示。反射具有抵消胜利者状态∣ *k* ⟩.的振幅的效果

1.  最后，我们反映出向量| *ψ* <sub>*中期*</sub> ⟩超过向量|*ψ*<sub>*eq*</sub>⟩其中|*ψ*<sub>*eq*</sub>⟩是对于 *n* 量子位的相等叠加态，即， ![$$ \frac{1}{\sqrt{N}}\ {\sum}_0^{N-1}\mid x\Big\rangle $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq32.png)沿一个矢量的反射|*ψ*<sub>*eq*</sub>⟩由下式给出:变换![$$ {U}_{\psi_{eq}}=2\left|{\psi}_{eq}\right\rangle \left\langle {\psi}_{eq}\right|-I $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq33.png)在| * c * ⟩和| * k * ⟩的这个二维基中，我们可以把|*ψ*<sub>*eq*</sub>⟩写成![$$ \left|{\psi}_{eq}\right\rangle =\left[\begin{array}{c} cos\theta \\ {} sin\theta \end{array}\right] $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq34.png)。

这使得酉变换![$$ {U}_{\psi_{eq}} $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq35.png)为:

![$$ {U}_{\psi_{eq}}=2\left|{\psi}_{eq}\right\rangle \left\langle {\psi}_{eq}\right|-I=\left[\begin{array}{cc}\mathit{\cos}2\theta &amp; \mathit{\sin}2\theta \\ {}\mathit{\sin}2\theta &amp; -\mathit{\cos}2\theta \end{array}\right] $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equ52.png)

(3-53)

在∣ *c* ⟩和∣ *k* ⟩的二维基础上，对|*ψ*T3】T4】midT6】⟩进行酉变换*cosθ*T9】sinθ<sup>*t*</sup>，得到∣*ψ*<sub>*out*</sub>

= ![$$ \left[\begin{array}{c}\mathit{\cos}3\theta \\ {}\mathit{\sin}3\theta \end{array}\right]=\mathit{\sin}3\theta \left|k\right\rangle +\mathit{\cos}3\theta \mid c\Big\rangle $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq37.png) (3-54)

于是，随着逐次酉变换 *U* <sub>*f*</sub> 接着是![$$ {U}_{\psi_{eq}}, $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq38.png)我们已经从状态|*ψ**⟩=*辛θ * | * k * ⟩ + *科斯θ * ∣ * c * ⟩到| * ψ * <sub> *出来*由于在第一象限内 *sin* 单调递增而 *cos* 单调递减，不难看出 *sin* 项给出的| * k * ⟩的幅度从 *sinθ* 增加到 *sin* 3 *θ* ，而∣ * c * ⟩给出的其余状态的幅度从 *cos 减小*</sub>*

 *1.  连续迭代地应用酉变换 *U* <sub>*f*</sub> 然后是![$$ {U_{\psi}}_{eq} $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq39.png)允许我们通过向其放大振幅来收敛到胜利者状态∣ * k * ⟩。我们可以将这两种变换组合为![$$ {U_{\psi}}_{eq}{U}_f $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq40.png)，称之为格罗夫变换 *G* 。因此，如果我们对 m 次迭代应用格罗弗变换，最终输出状态将非常接近∣⟩.

当我们使用属于具有四个项目的神谕的两输入量子位，即 *N* = 4 时，我们有以下:

![$$ sin\theta =\frac{1}{\sqrt{N}}=\frac{1}{\sqrt{4}}=\frac{1}{2} $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equ53.png)

(3-55)

所以，获胜项目的初始振幅对应的概率是。既然![$$ sin\theta =\frac{1}{2} $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq42.png)，那就意味着 *θ* = 30 。在酉变换 *U* <sub>* f *</sub> 后跟*U*<sub>*eq*</sub>之后，获胜项目的新振幅为*sin*3*θ*= sin(3×30<sup>【T22)=*sin*90<sup>= 1。这意味着在仅仅一次迭代中， ⟩中的起始状态| * ψ * <sub> *已经被转换为获胜项状态∣ * k * ⟩。*</sub></sup></sup>

1.  oracle 提供的 *U* <sub>*f*</sub> 转换与 Deutsch–Jozsa 和 Bernstein–Vajirani 算法中的相同。

2.  我们需要一种方法，根据量子算符得出酉变换![$$ {U_{\psi}}_{eq} $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq43.png)。就哈达玛门而言，![$$ {U_{\psi}}_{eq} $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq44.png)可以写成如下:

![$$ {U_{\psi}}_{eq}={H}^{\otimes n}{\left(2|0\right\rangle}^{\otimes n}{\left\langle 0\right|}^{\otimes n}-I\Big){H}^{\otimes n} $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equ54.png)

(3-56)

我们前面讨论过，![$$ {U_{\psi}}_{eq} $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq45.png)的作用是反映一个关于相等叠加态的矢量![$$ \left|{\psi}_{eq}\right\rangle =\frac{1}{\sqrt{N}}\ {\sum}_0^{N-1}\mid x\Big\rangle $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq46.png)我们可以简化![$$ {U_{\psi}}_{eq} $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq47.png)如下图:

![$$ {U_{\psi}}_{eq}={H}^{\otimes n}{\left(2|0\right\rangle}^{\otimes n}{\left\langle 0\right|}^{\otimes n}-I\Big){H}^{\otimes n} $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equt.png)

= 2(*h*<sup>*n*</sup>| 0*)(【0 |<sup>【t】</sup>*

 *= 2(*h*<sup>*n*</sup>| 0*)(【0 |<sup>【t】</sup>*

 *现在*h*T2】⊗*n*t5】|0⟩<sup>⊗*n*T9】什么都不是，而是等于叠加态为 *n* 个量子位，因此![$ {H}^{\otimes n}{\left|0\right\rangle}^{\otimes n}=\frac{1}{\sqrt{N}}\ {\sum}_0^{N-1}\left|x\right\rangle $](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq48.png)where*n*= 2<sup>*n*</sup>。同样，由于哈达玛变换 *H* 是幂等的，我们有*H*T23】2</sup>=*I*。使用这些信息，我们可以重写等式 [3-57](#Par201) ，如下所示:

![$$ {U_{\psi}}_{eq}=2\left(\frac{1}{\sqrt{N}}\ {\sum}_0^{N-1}\left|x\right\rangle \right)\left(\frac{1}{\sqrt{N}}\ {\sum}_0^{N-1}\left\langle x\right|\right)-I $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equu.png)

![$$ =2\left|{\psi}_{eq}\right\rangle \left\langle {\psi}_{eq}\right|-I $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equ55.png)
...
1.  看看如何实现(2 |0⟩<sup>⊗*n*T3】⟨0|<sup>⊗*n*T7*I*)让我们看看这个变换对基态∣ *x* ⟩.做了什么</sup></sup>
    1.  When the basis state is |*x*⟩ = |0⟩<sup>⊗*n*</sup>:
        ...
        ![$$ {\left(2|0\right\rangle}^{\otimes n}{\left\langle 0\right|}^{\otimes n}-I\Big){\left|0\right\rangle}^{\otimes n}={\left|0\right\rangle}^{\otimes n} $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equv.png)

    2.  When the basis state is |*x*⟩ ≠ |0⟩<sup>⊗*n*</sup>:

        ![$$ {\left(2|0\right\rangle}^{\otimes n}{\left\langle 0\right|}^{\otimes n}-I\left)\mid x\right\rangle $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equw.png)

![$$ ={\left(2|0\right\rangle}^{\otimes n}{\left\langle 0\right|}^{\otimes n}\left|x\right\rangle -\left|x\right\rangle $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equx.png)

![$$ =2{\left|0\right\rangle}^{\otimes n}.0-\left|x\right\rangle =-\mid x\Big\rangle $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_Equy.png)
...
![../images/495362_1_En_3_Chapter/495362_1_En_3_Fig7_HTML.jpg](../images/495362_1_En_3_Chapter/495362_1_En_3_Fig7_HTML.jpg)
...
该算法的另一个重要部分是构建反射操作符![$$ {U}_{\psi_{eq}} $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq49.png)，它将反映在 oracle 变换之后∣*ψ*T3】T4】中期 T6】⟩实现的状态*u*T9】T10】fT12】关于相等叠加状态∣*ψ*t15】t16】eqt18】⟩.对于大小为 4 的数据库，我们可以按照图 [3-8](#Fig8) 中 Grover 算法的电路图来实现。甲骨文*U*T23】T24】fT26】和弯曲运算符![$$ {U}_{\psi_{eq}} $$](../images/495362_1_En_3_Chapter/495362_1_En_3_Chapter_TeX_IEq50.png)组成格罗弗迭代器。通过 Grover 迭代器的几轮应用，人们应该能够以很高的概率测量赢家状态。对于使用两个量子位的计算基础状态索引的由四个项目组成的数据库，我们在一个 Grover 迭代器中收敛到赢家状态。

![../images/495362_1_En_3_Chapter/495362_1_En_3_Fig8_HTML.jpg](../images/495362_1_En_3_Chapter/495362_1_En_3_Fig8_HTML.jpg)
