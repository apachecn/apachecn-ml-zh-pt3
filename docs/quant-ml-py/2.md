...
![$$ {\left|w\right\rangle}_{B_2}=\hat{A}\left|{\phi}_k\right\rangle =A{\left|{\phi}_k\right\rangle}_{B_1}=A\left[\begin{array}{c}0\\ {}..\\ {}1\\ {}..\\ {}0\end{array}\right]=\left[\begin{array}{c}{a}_{0k}\\ {}{a}_{1k}\\ {}..\\ {}{a}_{\left(m-1\right)k}\end{array}\right] $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ7.png)
...
![$$ B\mid {v}_k\left\rangle =\sum \limits_{i=0}^{n-1}\left|{w}_i\right\rangle \left\langle {v}_i\right|{v}_k\right\rangle =\sum \limits_{i=0}^{n-1}\left\langle {v}_i|{v}_k\right\rangle \mid {w}_i\Big\rangle $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ12.png)
...
*   对于两个线性算子 *A* 和 *B* :
    ...
    ![$$ trace\left(A+B\right)= trace(A)+ trace(B) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ30.png)
...
*![$$ ={\alpha}_k^{\ast }{\alpha}_k\left\langle {\phi}_k|{\phi}_k\right\rangle \left\langle {\phi}_k|{\phi}_k\right\rangle ={\left|{\alpha}_k\right|}^2 $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ59.png)*
...
![$$ E\left[M\right]=\sum \limits_k kp(k)=\kern0.5em \sum \limits_kk\Big\langle \psi \mid {P}_k\left|\psi \right\rangle $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equq.png)
...
![$$ \left\langle {v}_1|{v}_2\right\rangle +\left\langle {v}_2|{v}_1\right\rangle =2 Real\left(\left\langle v1|{v}_2\right\rangle \right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equr.png)
...
![$$ =\left\Vert i\left\langle \psi \left| MN- NM\right|\psi \right\rangle \right\Vert $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equaa.png)
...
鼓励有兴趣了解量子力学更多细节的读者推导出关系式![$$ \left[\hat{x},\hat{p}\right]=\hat{x}\hat{p}-\hat{p}\hat{x}= i\mathit{\hslash} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq43.png)
...
希尔伯特空间 *V* 中的正算子 *A* 是满足⟨*ψ*|*a*|*ψ*⟩≥0 for every |*ψ*⟩∈*v*的算子。因此，确保算子 *E* <sub>*k*</sub> 为正，将确保我们得到由 *P* ( *k* ) ≥ 0 表示的概率。如果我们有我们感兴趣的 *N* 个结果，我们将不得不构建正算子 *E* <sub>*k*</sub> 以满足完备性方程；即![$$ \sum \limits_k{E}_k=I $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq44.png)运算符 *E* <sub>* k *</sub> 称为 POVM 元素，而全集{*E*<sub>*k*</sub>}称为 POVM。与射影测量运算符{*P*<sub>*k*</sub>}不同，POVM 运算符{*E*<sub>*k*</sub>】不需要满足关系*E*<sub>*n*</sub>*E*<sub>*m*</sub>=因此，正测量算子{*E*<sub>*k*</sub>}并不局限于仅测量与一组正交基状态相关的结果。因此，在这个意义上，POVM 比投影测度算子更一般，而后者实际上是前者的一个特例。与其将投影测量作为 POVM 的特例，不如让我们来看看 POVM 不同于投影测量的更有趣的情况。假设我们想检测两个不一定正交的状态。我们可以把两个状态分别取为| * ψ * <sub> 1 </sub> ⟩ = ∣0⟩和![$$ \left|{\psi}_2\right\rangle =\frac{1}{\sqrt{2}}\left(|0\Big\rangle +|1\Big\rangle \right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq45.png)。不用说，由于∣ * ψ * <sub> 1 </sub> ⟩和∣ * ψ * <sub> 2 </sub> ⟩.这两个国家之间的重叠，我们不可能完全确定地衡量这两个国家让我们按如下方式定义三个 POVM 元素，并看看如何最好地检测这两个事件:

![$$ {E}_1=\frac{\sqrt{2}}{\left(1+\sqrt{2}\right)}\left|1\right\rangle \left\langle 1\right| $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equaf.png)

![$$ {E}_2=\frac{\sqrt{2}}{\left(1+\sqrt{2}\right)}\left(|0\Big\rangle -|1\Big\rangle \right)\left(\right\langle 0\mid -\left\langle 1\mid \right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equag.png)

![$$ {E}_3=I-{E}_1-{E}_2 $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ91.png)

(2-91)

如果测量的状态是|*ψ*T2】1⟩=|0⟩，那么*e*T6】1 将永远不会被观察到，因为它对应于正交状态∣1⟩.但是，如果检测到 *E* <sub>1</sub> ，我们可以有把握地推断，被测量的状态必须是类似线上的状态![$$ \left|{\psi}_2\right\rangle =\frac{1}{\sqrt{2}}\left(|0\Big\rangle +|1\Big\rangle \right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq46.png)，如果检测到 *E* <sub>2</sub> ，则必须是状态| * ψ * <sub> 1 </sub> ⟩ = ∣ 0⟩.它不可能是状态![$$ \left|{\psi}_2\right\rangle =\frac{1}{\sqrt{2}}\left(|0\Big\rangle +|1\Big\rangle \right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq47.png)，因为它正交于(| 0⟩−| 1⟩).当检测到*E*T24】3 时，我们无法肯定地说出被测状态。这里的中心点是，使用 POVM，我们永远不会错误地识别我们要测量的状态。只是有时我们无法确定我们所呈现的真实状态。

### 密度算子

到目前为止，我们一直使用状态向量| *ψ* ⟩来表示一个量子系统。量子系统也可以用密度算符 *ρ* 来表示。对于一个与周围环境隔离的量子系统，我们到目前为止一直在研究的纯量子态，密度算符只不过是状态向量∣ *ψ* ⟩与其自身的外积。于是，我们有了这个:

![$$ \rho =\mid \psi \left\rangle \right\langle \psi \mid $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ92.png)

(2-92)

密度算子的迹为 1，如下图:

![$$ trace\left(\rho \right)= tr\left(|\psi \right\rangle \left\langle \psi |\right)=\left\langle \psi |\psi \right\rangle =1 $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ93.png)
...
![$$ \rho =\sum \limits_i{p}_i\mid {\psi}_i\left\rangle \right\langle {\psi}_i\mid $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ94.png)
...
![$$ {\rho}_2=\sum \limits_i{p}_iU\left({t}_2,{t}_1\right)\mid {\psi}_i\left({t}_1\right)\left\rangle \right\langle {\psi}_i\left({t}_1\right)\mid {U}^{\dagger}\left({t}_2,{t}_1\right)\kern2.5em =U\left({t}_2,{t}_1\right)\left(\sum \limits_i{p}_i\left|{\psi}_i\left({t}_1\right)\right\rangle \left\langle {\psi}_i\left({t}_1\right)\right|\right){U}^{\dagger}\left({t}_2,{t}_1\right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equah.png)

![$$ =U\left({t}_2,{t}_1\right){\rho}_1{U}^{\dagger}\left({t}_2,{t}_1\right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ96.png)
...
![$$ P\left(m/i\right)=\left\langle {\psi}_i|{M}_m^{\dagger }{M}_m|{\psi}_i\right\rangle $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ97.png)

(2-97)

对所有不同的纯态求和的结果的概率由下面给出:

![$$ P(m)=\sum \limits_iP\left(m/i\right)P\left({\psi}_i\right)\kern0.5em =\sum \limits_i\left\langle {\psi}_i|{M}_m^{\dagger }{M}_m|{\psi}_i\right\rangle {p}_i $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ98.png)

(2-98)

利用 trace 技巧，我们可以写出![$$ \left\langle {\psi}_i|{M}_m^{\dagger }{M}_m|{\psi}_i\right\rangle $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq48.png) = ![$$ tr\left({M}_m^{\dagger }{M}_m\mid {\psi}_i\right\rangle \left\langle {\psi}_i\mid \right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq49.png)，这样就把方程 [2-98](#Equ98) 简化为:

![$$ P(m)=\sum \limits_i tr\left({M}_m^{\dagger }{M}_m\mid {\psi}_i\right\rangle \left\langle {\psi}_i\mid \right){p}_i= tr\left({M}_m^{\dagger }{M}_m\sum \limits_i{p}_i\left|{\psi}_i\right\rangle \left\langle {\psi}_i\right|\right)= tr\left({M}_m^{\dagger }{M}_m\rho \right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ99.png)
...
![$$ \left|{\psi}_i^{(m)}\right\rangle =\frac{M_m\left|{\psi}_i\right\rangle }{\sqrt{\left\langle {\psi}_i|{M}_m^{\dagger }{M}_m|{\psi}_i\right\rangle}\kern0.5em } $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ100.png)

(2-100)

对应的密度算子![$$ {\rho}_i^{(m)} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq50.png)由下式给出:

![$$ {\rho}_i^{(m)}=\frac{M_m\left|{\psi}_i\right\rangle \left\langle {\psi}_i\right|{M}_m^{\dagger }}{\left\langle {\psi}_i|{M}_m^{\dagger }{M}_m|{\psi}_i\right\rangle \kern0.5em } $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ101.png)

(2-101)

测量结果 *m* 后的密度算子 *ρ* <sup>( *m* )</sup> 是在给定结果 *m* 的情况下![$$ {\rho}_i^{(m)} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq51.png)对不同纯态的条件分布的期望，即*P*(*I*/*m*)。

![$$ {\rho}^{(m)}=\sum \limits_iP\left(i/m\right){\rho}_i^{(m)} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ102.png)

(2-102)

现在 *P* ( *i* / *m* )可以使用等式 [2-97](#Equ97) 和 [2-99](#Equ99) 计算如下。

![$$ P\left(i/m\right)=\frac{P\left(m/i\right)P(i)}{P(m)}=\frac{\left\langle {\psi}_i|{M}_m^{\dagger }{M}_m|{\psi}_i\right\rangle {p}_i}{tr\left({M}_m^{\dagger }{M}_m\rho \right)} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ103.png)

(2-103)

将方程 [2-103](#Equ103) 中的 *P* ( *i* / *m* )和方程 [2-101](#Equ101) 中的![$$ {\rho}_i^{(m)} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq52.png)代入方程 [2-102](#Equ102) 中，我们得到如下:

![$$ {\rho}^{(m)}=\sum \limits_i\frac{\left\langle {\psi}_i|{M}_m^{\dagger }{M}_m|{\psi}_i\right\rangle {p}_i}{tr\left({M}_m^{\dagger }{M}_m\rho \right)}\frac{M_m\left|{\psi}_i\right\rangle \left\langle {\psi}_i\right|{M}_m^{\dagger }}{\left\langle {\psi}_i|{M}_m^{\dagger }{M}_m|{\psi}_i\right\rangle} = \sum \limits_i\frac{M_m{p}_i\left|{\psi}_i\right\rangle \left\langle {\psi}_i\right|{M}_m^{\dagger }}{tr\left({M}_m^{\dagger }{M}_m\rho \right)\kern0.5em } $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equai.png)

![$$ ={M}_m\sum \limits_i\frac{p_i\left|{\psi}_i\right\rangle \left\langle {\psi}_i\right|}{tr\left({M}_m^{\dagger }{M}_m\rho \right)\kern0.5em }{M}_m^{\dagger }=\frac{M_m\rho {M}_m^{\dagger }}{tr\left({M}_m^{\dagger }{M}_m\rho \right)\kern0.5em } $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ104.png)
...
![$$ \rho ={\rho}_1\otimes {\rho}_2\otimes \dots \otimes {\rho}_n $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ105.png)
...
![$$ {\rho}_A=t{r}_B\left({\rho}_{AB}\right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ106.png)
...
贝尔态![$$ \left|\psi \right\rangle =\frac{1}{\surd 2\ }\left(\left|00\right\rangle +|11\Big\rangle \right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq53.png)的密度算符由下式给出:

![$$ {\rho}_{AB}=\frac{1}{2}\left(\left|00\right\rangle +|11\Big\rangle \right)\times \left(\right\langle 00\mid +\left\langle 11\mid \right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ108.png)

(2-108)

对等式 [2-107](#Equ108) 中的项展开，我们得到如下:

![$$ {\rho}_{AB}=\frac{\left|00\right\rangle \left\langle 00|+\left|00\right\rangle \left|11\right\rangle \right)+\mid 11\left\rangle \left\langle 00|+|11\right\rangle \right\langle 11\mid }{2} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ109.png)

(2-109)

我们可以进一步简化这四项中的每一项，并将它们表示为量子位基本密度算符的张量积。

![$$ {\rho}_{AB}=\frac{1}{2}\left(\ {\left|0\right\rangle}_A{\left\langle 0{\left.\kern0em \right|}_A\otimes |0\right\rangle}_B\right\langle 0{\left.\kern0em \right|}_B+{\left|0\right\rangle}_A{\left\langle 1{\left.\kern0em \right|}_A\otimes |0\right\rangle}_B\Big\langle 1{\left.\kern0em \right|}_B+ $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equaj.png)T2】

现在对量子位 B 进行部分追踪，我们从方程 [2-110](#Equ108) 得到如下:

![$$ {\rho}_A= tr\left({\rho}_{AB}\right)=\frac{1}{2}\left(\ {\left|0\right\rangle}_A{\left\langle 0{\left.\kern0em \right|}_A\  tr\Big(|0\right\rangle}_B\right\langle 0{\left.\kern0em \right|}_B\left)+{\left|0\right\rangle}_A{\left\langle 1{\left.\kern0em \right|}_A\  tr\Big(|0\right\rangle}_B\right\langle 1{\left.\kern0em \right|}_B\Big)+ $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equak.png)

![$$ =\frac{1}{2}\left(\ {\left|0\right\rangle}_A\right\langle 0{\left.\kern0em \right|}_A{\left\langle 0|0\right\rangle}_B+{\left|0\right\rangle}_A\left\langle 1{\left.\kern0em \right|}_A{\left\langle 0|1\right\rangle}_B+{\left|1\right\rangle}_A\right\langle 0{\left.\kern0em \right|}_A{\left\langle 1|0\right\rangle}_B+{\left|1\right\rangle}_A\Big\langle 1{\left.\kern0em \right|}_A{\left\langle 1|1\right\rangle}_B $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ111.png)

(2-111)

在方程 [2-111](#Equ111) 中，第二项和第三项将会消失，因为点积涉及到 *B* 的正交基态，这给了我们 *A* 的密度算符如下:

![$$ {\rho}_A=\frac{1}{2}\ {\left|0\right\rangle}_A\left\langle 0{\left.\kern0em \right|}_A+\frac{1}{2}\ {\left|1\right\rangle}_A\right\langle 1{\left.\kern0em \right|}_A=\frac{I}{2} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ112.png)

(2-112)

如果我们仔细观察 *A* 即![$$ {\rho}_A^2 $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq54.png)的密度算符平方的轨迹，我们看到它不等于 1。

![$$ tr\left({\rho}_A^2\right)== tr\left(\frac{I}{4}\right)=\frac{1}{4}&lt;1 $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ113.png)
...
![../images/495362_1_En_2_Chapter/495362_1_En_2_Fig5_HTML.jpg](../images/495362_1_En_2_Chapter/495362_1_En_2_Fig5_HTML.jpg)

图 2-5

通用量子门集

对爱丽丝量子位的测量产生 *M* 、T2【1】T3 和 *M* 、T6】 2 作为控制鲍勃量子位上酉运算![$$ {X}^{M_2} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq55.png)和![$$ {Z}^{M_1} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq56.png)的测量结果。Alice 量子位的两个测量值都可以移到电路的末端，而不会影响结果，如图 [2-6](#Fig6) 所示。

![../images/495362_1_En_2_Chapter/495362_1_En_2_Fig6_HTML.jpg](../images/495362_1_En_2_Chapter/495362_1_En_2_Fig6_HTML.jpg)
...
在传统的计算模式中，一小组门，如与门、或门和非门，可以用来实现任何传统的功能。因此，这样一组门被认为是经典计算的通用门。在量子计算范例中，如果任何给定的幺正算符可以被由通用集合中的这些门组成的量子电路近似到任意精度，则一组门被认为是通用的。在第 [1](1.html) 章中，我们在实现一些量子算法的时候已经触及了 CNOT 门和哈达玛门。这两个门以及相位和![$$ \frac{\pi }{8} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq57.png)门被认为是通用的，因为使用这些门可以将任何酉门近似到任意精度。图 [2-7](#Fig7) 显示了四个门及其酉变换，以供参考。

![../images/495362_1_En_2_Chapter/495362_1_En_2_Fig7_HTML.jpg](../images/495362_1_En_2_Chapter/495362_1_En_2_Fig7_HTML.jpg)
...
![$$ E\left(U,V\right)=\underset{\mid \psi \Big\rangle\ }{\max}\left\Vert \left(U-V\right)|\psi \Big\rangle \right\Vert $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ114.png)
...
![$$ \left\Vert {p}_k(U)-{p}_k(V)\right\Vert =\left\Vert \left\langle \psi \left|{U}^{\dagger }{M}_kU\right|\psi \right\rangle -\left\langle \psi \left|{V}^{\dagger }{M}_kV\right|\psi \right\rangle \right\Vert $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ117.png)

(2-117)

如果我们用∣ *δ* ⟩来表示期望变换 U∣ *ψ* ⟩与实际变换 *V* ∣ *ψ* ⟩之差的*l*2 范数，那么我们就有了这个:

![$$ \left|\delta \right\rangle =\left(U-V\right)\mid \psi \Big\rangle $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ118.png)

(2-118)

从方程 [2-118](#Equ116) 我们得到*u*∣*ψ*⟩= |*δ*⟩+*v*∣*ψ*⟩和⟨*ψ*∣*v*<sup>=⟨*ψ*∣*u*<sup>利用这些表达式对于 *U* ∣ *ψ* ⟩和⟨*ψ*∣*v*v<sup>t35】在方程 [2-117](#Equ117) 中，我们有这样的:</sup></sup></sup>

![$$ \left\Vert {p}_k(U)-{p}_k(V)\right\Vert $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equam.png)

![$$ =\left\Vert \left\langle \psi |{U}^{\dagger }{M}_k\left(\left|\delta \right\rangle +V|\psi \right\rangle \right)-\left(\left\langle \psi |{U}^{\dagger }+\left\langle \delta \right|\right)\left|{V}^{\dagger }{M}_kV\right|\psi \right\rangle \right\Vert $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equan.png)

![$$ =\left\Vert \left\langle \psi \left|{U}^{\dagger }{M}_k\right|\delta \right\rangle +\left\langle \delta \left|{M}_kV\right|\psi \right\rangle \right\Vert $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ119.png)

(2-119)

利用方程 [2-119](#Equ119) 上的柯西-施瓦茨不等式，我们得到如下:

![$$ \left\Vert {p}_k(U)-{p}_k(V)\right\Vert =\left\Vert \left\langle \psi \left|{U}^{\dagger }{M}_k\right|\delta \right\rangle +\left\langle \delta \left|{M}_kV\right|\psi \right\rangle \right\Vert $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equao.png)

![$$ \le \left\Vert \left\langle \psi \left|{U}^{\dagger }{M}_k\right|\delta \right\rangle \right\Vert +\left\Vert \left\langle \delta \left|{M}_kV\right|\psi \right\rangle \right\Vert $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equap.png)

![$$ \le \left\Vert |\delta \Big\rangle \right\Vert +\left\Vert |\delta \Big\rangle \right\Vert $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ120.png)

(2-120)

现在| *δ* ⟩的最大范数是 *E* ( *U* ， *V* )，如公式 [2-114](#Equ114) 所示。这允许我们将方程 [2-120](#Equ118) 绑定为:

![$$ \left\Vert {p}_k(U)-{p}_k(V)\right\Vert \le \left\Vert \left|\delta \right\rangle \right\Vert +\left\Vert \left|\delta \right\rangle \right\Vert $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equaq.png)

![$$ \le \left\Vert \left|\delta \right\rangle \right\Vert +\left\Vert \left|\delta \right\rangle \right\Vert $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equar.png)

![$$ \le 2E\left(U,V\right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ121.png)
...
![$$ E\left({U}_n{U}_{n-1}\dots {U}_1,{V}_n,{V}_{n-1},\dots {V}_1\right)\le {\sum}_{j=1}^nE\left({U}_j,{V}_j\right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ122.png)
...
![$$ E\left({U}_2{U}_1,{V}_2,{V}_1\right)=\left\Vert \left({U}_2{U}_1-{V}_2{V}_1\right)|\psi \Big\rangle \right\Vert $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ123.png)

(2-123)

加减*v*<sub>2</sub>*u*<sub>1</sub>∣*ψ*⟩在等式右边的范数内然后应用三角不等式，我们有如下:

![$$ E\left({U}_2{U}_1,{V}_2,{V}_1\right)=\left\Vert \left({U}_2{U}_1-{V}_2{U}_1+{V}_2{U}_1-{V}_2{V}_1\right)|\psi \Big\rangle \right\Vert $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equas.png)

![$$ \le \left\Vert \left({U}_2-{V}_2\right){U}_1|\psi \Big\rangle \right\Vert +\left\Vert \left({U}_1-{V}_1\right){V}_2|\psi \Big\rangle \right\Vert $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ124.png)

(2-124)

由于 *U* <sub>1</sub> 和 *V* <sub>2</sub> 是酉算子，它们对范数的贡献是 1，因此我们可以将方程 [2-124](#Equ124) 写成如下:

![$$ E\left({U}_2{U}_1,{V}_2,{V}_1\right)\le \kern0.5em \left\Vert \left({U}_2-{V}_2\right)|\psi \Big\rangle \right\Vert +\left\Vert \left({U}_1-{V}_1\right)|\psi \Big\rangle \right\Vert $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equat.png)

![$$ \le E\left({U}_2,{V}_2\right)+E\left({U}_1,{V}_1\right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ125.png)
...
solovay-kita ev 指出，如果 *V* ⊆ *SU* ( *d* )是逆闭的通用门族(即，如果*x*∑*v*，则*x*<sup>—1</sup>∑*v*和 *V* 生成 *SU* 的稠密子集) *ϵ* > 0，存在元素 *v* <sub>1</sub> ，*v*<sub>2</sub>…*v*<sub>*k*</sub>∑*v*使得![$$ \left\Vert U-{U}_{v_1}{U}_{v_2}\dots {U_v}_k\right\Vert \le \epsilon $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq58.png)和![$$ k=O\left({\log}^2\frac{1}{\epsilon\ }\right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq59.png)因此，索洛瓦伊-基塔耶夫定理给出了对通用集合*所需门的近似数目的估计 逼近幺正算子的可接受误差越小，构建这种幺正门所需的通用集合中的门的数量就越大。*
...
![../images/495362_1_En_2_Chapter/495362_1_En_2_Fig8_HTML.jpg](../images/495362_1_En_2_Chapter/495362_1_En_2_Fig8_HTML.jpg)
...
![$$ QS+ RS+ RT- QT=S\left(Q+R\right)+T\left(R-Q\right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ126.png)

(2-126)

从等式 [2-126](#Equ126) 中，很容易看出在某一时刻 *S* ( *Q* + *R* )或*T*(*R*-*Q*)中的任何一个都是非零的，并且非零值将是+2 或-2。于是:

![$$ QS+ RS+ RT- QT\le 2 $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ127.png)
...
![$$ \mathbbm{E}\left[ QS\left]+\mathbbm{E}\left[ RS\right]+\mathbbm{E}\left[ RT\right]-\mathbbm{E}\right[ QT\right]\le 2 $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ129.png)
...
![$$ \left|\uppsi \right\rangle =\frac{1}{\sqrt{2}}\left(\left|01\right\rangle -|10\Big\rangle \right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ130.png)

(2-130)

科林将第一个量子位传给爱丽丝，将第二个量子位传给鲍勃进行测量。爱丽丝对可观测量 *Q* 和 *R* 进行测量，我们分配如下:

![$$ \mathrm{Q}=Z $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equaw.png)

![$$ R=X $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ131.png)

(2-131)

同样，鲍勃对可观测量 *S* 和 *T* 进行测量，我们分配如下:

![$$ \mathrm{S}=\frac{-Z-X}{\sqrt{2}} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equax.png)

![$$ T=\frac{Z-X}{\sqrt{2}} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ132.png)

(2-132)

在方程 [2-131](#Equ131) 和 [2-132](#Equ132) ， *Z* 和 *X* 是泡利矩阵。就像之前一样，我们在量子力学的意义上计算了关于纠缠态∣的期望值例如，![$$ \mathbbm{E}\left[ QS\right] $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq62.png)相对于状态| * ψ * ⟩可以表述如下:

![$$ \mathbbm{E}\left[ QS\right]={\left\langle Q\otimes S\right\rangle}_{\psi }=\left\langle \psi \left|Q\otimes S\right|\psi \right\rangle $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equay.png)

![$$ =\left\langle \psi \left|Z\otimes X\right|\psi \right\rangle $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equaz.png)

![$$ =\frac{1}{\sqrt{2}}\left(\right\langle 01\mid -\left\langle 10\mid \right)\left[\begin{array}{cc}1&amp; 0\\ {}0&amp; -1\end{array}\right]\otimes \left[\begin{array}{cc}0&amp; 1\\ {}1&amp; 0\end{array}\right]\frac{1}{\sqrt{2}}\left(\left|01\right\rangle -|10\Big\rangle \right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equba.png)

![$$ =\frac{1}{\sqrt{2}\ } $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ133.png)

(2-133)

计算![$$ \mathbbm{E}\left[ QS\left]+\mathbbm{E}\left[ RS\right]+\mathbbm{E}\left[ RT\right]-\mathbbm{E}\right[ QT\right] $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq63.png)中每一项的期望值，我们会看到如下:

![$$ \mathbbm{E}\left[ QS\right]=\mathbbm{E}\left[ RS\right]=\mathbbm{E}\left[ RT\right]=\frac{1}{\sqrt{2}\kern0.5em } $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equbb.png)

![$$ \mathbbm{E}\left[ QT\right]=-\frac{1}{\sqrt{2}} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ134.png)

(2-134)

因此，![$$ \mathbbm{E}\left[ QS\left]+\mathbbm{E}\left[ RS\right]+\mathbbm{E}\left[ RT\right]-\mathbbm{E}\right[ QT\right] $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq64.png)的总体期望结果如下:

![$$ \mathbbm{E}\left[ QS\left]+\mathbbm{E}\left[ RS\right]+\mathbbm{E}\left[ RT\right]-\mathbbm{E}\right[ QT\right]=2\sqrt{2} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ135.png)

(2-135)

在等式 [2-129](#Equ129) 中，我们可以看到，使用普通世界如何工作或者 ERP 如何感知世界的敏感度给了我们一个上界期望![$$ \mathbbm{E}\left[ QS\left]+\mathbbm{E}\left[ RS\right]+\mathbbm{E}\left[ RT\right]-\mathbbm{E}\right[ QT\right] $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq65.png)为 2。然而，我们可以看到，量子力学对期望![$$ \mathbbm{E}\left[ QS\left]+\mathbbm{E}\left[ RS\right]+\mathbbm{E}\left[ RT\right]-\mathbbm{E}\right[ QT\right] $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq67.png)产生了一个值![$$ 2\sqrt{2} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq66.png)，这违反了贝尔不等式。这意味着我们在推导贝尔不等式时所做的一个或多个假设一定是错误的。贝尔不等式或爱因斯坦、罗森和波多尔斯基在这方面可能做出的错误假设可以总结如下:
...
量子系统在常数哈密顿量 *H* 下的演化由薛定谔方程![$$ i\mathit{\hslash}\frac{d\mid \psi (t)\Big\rangle }{dt}=H\mid \psi (t)\Big\rangle $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq68.png)给出。薛定谔方程的解给出了态矢∣ * ψ * ⟩在时间*t*T7】0 和 *t* 之间的幺正演化为|*ψ*(*t*<sub>1</sub>)⟩=*u*(*t*<sub>1</sub>， *t* 

在哈密顿模拟中，给定一个哈密顿量 *H* 和一个演化时间 *t* ，我们需要组合一系列门来实现酉算符![$$ U\left(t,0\right)={e}^{-\frac{iHt}{\hslash }} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq70.png)。哈密顿模拟是使用绝热计算的算法的一个重要组成部分，例如我们将在第 [7](7.html) 章中研究的量子近似优化算法(QAOA)。大多数物理系统中的哈密顿量可以表示为仅仅几个粒子的局部相互作用之和。这样，对于一个 *n* 体量子系统，我们可以把哈密顿量写成如下:

![$$ H=\sum \limits_k{H}_k $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ136.png)

(2-136)

每一个 *H* <sub>*k*</sub> 哈密顿量往往就像两个身体的相互作用一样简单。这里要强调的一点是，![$$ {e}^{-i{H}_kt} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq71.png)比酉算子*e*<sup>*iHt*</sup>更容易用量子门构建，因为它在局部级别上作用于更小的子系统。如果我们能够表达![$$ {e}^{- iHt}=\prod \limits_k{e}^{-i{H}_kt} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq72.png)，那么轻松构建![$$ {e}^{-i{H}_kt} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq73.png)的能力将会非常有用。然而，一般来说，![$$ {e}^{- iHt}\ne \prod \limits_k{e}^{-i{H}_kt} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq74.png)是因为一般来说单个局域哈密顿量不可交换，即*H*<sub>*k*</sub>*H*<sub>*l*</sub>≦*H*<sub>*l*</sub>*H*<sub>*k*</sub>。事实证明，即使两个哈密顿量 *H* <sub>1</sub> 和 *H* <sub>2</sub> 不交换，也可以利用 Trotter 公式模拟单个哈密顿量来模拟整体哈密顿量。

两个埃尔米特矩阵 *H* <sub>1</sub> 和 *H* <sub>2</sub> 的托特公式表示如下:

![$$ {e}^{-i\left({H}_1+{H}_2\right)t}=\underset{n\to \infty }{\lim }{\left({e}^{\frac{-i{H}_1t}{n}}{e}^{\frac{-i{H}_2t}{n}}\right)}^n $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ137.png)

(2-137)

我们来试着推导一下托特公式的证明。首先，![$$ {e}^{\frac{-i{H}_1t}{n}} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq75.png)可以展开为:

![$$ {e}^{\frac{-i{H}_1t}{n}}=I-\frac{1}{n}i{H}_1t+O\left(\frac{1}{n^2}\right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ138.png)

(2-138)

O 的*(。)表示大 O 的计算复杂度。*

结合对![$$ {e}^{\frac{-i{H}_1t}{n}} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq76.png)和![$$ {e}^{\frac{-i{H}_2t}{n}} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq77.png)的展开，我们得到以下结果:

![$$ {e}^{\frac{-i{H}_1t}{n}}{e}^{\frac{-i{H}_2t}{n}}=I-\frac{1}{n}i\left(\ {H}_1+{H}_2\right)t+O\left(\frac{1}{n^2}\right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ1137.png)

(2-139)

取方程 [2-139](#Equ137) 两边的 n 次方，我们有这个:

![$$ {\left({e}^{\frac{-i{H}_1t}{n}}{e}^{\frac{-i{H}_2t}{n}}\right)}^n $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equbc.png)

![$$ =I+\sum \limits_{k=1}^n\left(\genfrac{}{}{0pt}{}{n}{k}\right)\ \frac{{\left(-1\right)}^k}{n^k}\left[i\Big(\ {H}_1+{H}_2\right)t\Big]{}^k\kern0.5em +O\left(\frac{1}{n}\right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ1138.png)

(2-140)

通过一点计算，我们可以将![$$ \left(\genfrac{}{}{0pt}{}{n}{k}\right)\frac{1}{n^k} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq78.png)简化为如下:

![$$ \left(\genfrac{}{}{0pt}{}{n}{k}\right)\ \frac{1}{n^k}=\frac{1+O\left(\frac{1}{n}\right)}{k!} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ1139.png)

(2-141)

利用方程 [2-141](#Equ139) ，我们可以将 [2-140](#Equ138) 简化如下:

![$$ {\left({e}^{\frac{-i{H}_1t}{n}}{e}^{\frac{-i{H}_2t}{n}}\right)}^n=I+\sum \limits_{k=1}^n\frac{\left[-i\Big(\ {H}_1+{H}_2\right)t\Big]{}^k}{k!}\kern0.5em +O\left(\frac{1}{n}\right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ1140.png)

(2-142)

取 [2-140](#Equ1138) 两侧的极限 *n* → ∞我们得到这个:

![$$ \underset{n\to \infty }{\lim }{\left({e}^{\frac{-i{H}_1t}{n}}{e}^{\frac{-i{H}_2t}{n}}\right)}^n $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equbd.png)

![$$ =\underset{n\to \infty }{\lim }I+\sum \limits_{k=1}^n\frac{\left[-i\Big(\ {H}_1+{H}_2\right)t\Big]{}^k}{k!}\kern0.5em +O\left(\frac{1}{n}\right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Eqube.png)

![$$ =\underset{n\to \infty }{\lim }\ \sum \limits_{k=0}^n\frac{\left[-i\Big(\ {H}_1+{H}_2\right)t\Big]{}^k}{k!}\kern0.5em +O\left(\frac{1}{n}\right) $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equbf.png)

![$$ ={e}^{-i\left({H}_1+{H}_2\right)t} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ139.png)

(2-143)

基于 Trotter 公式，可以通过在如下的 *H* <sub>1</sub> 和 *H* <sub>2</sub> 之间交替获得的一系列酉算子来实现酉算子![$$ {e}^{-i\left({H}_1+{H}_2\right)t} $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_IEq79.png):

![$$ {e}^{\frac{-i{H}_1t}{n}},{e}^{\frac{-i{H}_2t}{n}},{e}^{\frac{-i{H}_1t}{n}},{e}^{\frac{-i{H}_2t}{n}},\dots \dots . $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ1142.png)
...
![$$ {e}^{\frac{-i{H}_1t}{n}},{e}^{\frac{-i{H}_2t}{n}},{e}^{\frac{-i{H}_3t}{n}},{e}^{\frac{-i{H}_1t}{n}},{e}^{\frac{-i{H}_2t}{n}},{e}^{\frac{-i{H}_3t}{n}}\dots \dots . $$](../images/495362_1_En_2_Chapter/495362_1_En_2_Chapter_TeX_Equ1143.png)
