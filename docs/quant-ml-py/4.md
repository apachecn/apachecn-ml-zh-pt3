...
当*k*<sub>2</sub>≦*k*<sub>1</sub>，*k*<sub>2</sub>—*k*<sub>1</sub>为非零整数。对于*k*T18】2 至*k*T22】1、![$$ {e}^{2\pi i\left({k}_2-{k}_1\right)}=1 $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq4.png)的任意非零整数值。这使得方程 [4-3](#Equ3) 中的点积表达式为零。
...
![../images/495362_1_En_4_Chapter/495362_1_En_4_Fig2_HTML.jpg](../images/495362_1_En_4_Chapter/495362_1_En_4_Fig2_HTML.jpg)
...
![$$ \left|{x}_1\right\rangle \to \frac{1}{\sqrt{2}}\left(\left|0\right\rangle +{e}^{-2\pi i0.{x}_1{x}_2}\ |1\Big\rangle \right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ35.png)
...
![$$ \left|{x}_1{x}_2..{x}_n\right\rangle \to \frac{1}{2^{\frac{n}{2}}}\sum \limits_{k_1=0}^1..\sum \limits_{k_n=0}^1{e}^{-2\pi ix\left(\sum \limits_{p=1}^n\frac{k_p}{2^p}\right)}\left|{k}_1{k}_2\dots {k}_n\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ43.png)
...
**![$$ {\phi}_F=\frac{\phi_I}{2^n} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ65.png)**
...
当 *θ* = *π* 时，前面的比值达到最大值![$$ \frac{\pi }{2} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq60.png)。于是，我们有了下面的不等式:
...
![$$ \theta \ge \left|1-z\right| $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equw.png)

![$$ \to -2\pi \delta \ge \left|1-{e}^{-2\pi i\delta}\ \right| $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equx.png)

![$$ \to 4{\pi}^2{\delta}^2\ge \mid 1-{e}^{-2\pi i\delta}\ {\left.\kern0em \right|}^2 $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ82.png)

(4-83)

结合方程 [4-82](#Equ81) 和方程 [4-83](#Equ82) ，我们得到如下:

![$$ P\left(\frac{x}{2^n}={\phi}_{approx}\right)\ge \frac{4^2{\delta}^2{2}^{2n}}{2^{2n}4{\pi}^2{\delta}^2}=\frac{4}{\pi^2}&gt;0.4 $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ83.png)
...
![$$ f(x)={a}^x\ \left(\mathit{\operatorname{mod}}\ N\right). $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ84.png)

(4-85)

我们需要找到函数 *f* ( *x* )的顺序 *r* 使得*f*(*x*+*r*)=*f*(*x*)。利用方程 [4-85](#Equ84) ，我们得到如下:

![$$ f\left(x+r\right)=f(x). $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ85.png)

(4-86)

![$$ \to {a}^{x+r}\ \left(\mathit{\operatorname{mod}}\ N\right)={a}^x\ \left(\mathit{\operatorname{mod}}\ N\right). $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ86.png)
...
![$$ {a}^{x+r}-{a}^x=\left({m}_1-{m}_2\right)N\to {a}^x\left({a}^r-1\right)=\left({m}_1-{m}_2\right)N $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ87.png)

(4-88)

现在我们知道了*a*<sup>T3】xT5】不能被 *N* 整除既然*a*<sup>*x*</sup>=*k*+*m*<sub>2</sub>*N*。所以从方程 [4-88](#Equ87) ，(*a*<sup>*r*</sup>—1)一定能被 *N* 整除。就模除法而言，我们可以这样写:</sup>

![$$ {a}^r-1\equiv 0\ \left(\mathit{\operatorname{mod}}\ N\right). $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ88.png)

(4-89)

![$$ \to {a}^r\equiv 1\ \left(\mathit{\operatorname{mod}}\ N\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ89.png)
...
![$$ {U}_a\mid y\left\rangle =\mid ay\ \mathit{\operatorname{mod}}\ N\right\rangle . $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ90.png)

(4-91)

这里的想法是有一个操作符，当它被应用于一个元素时，r 次产生元素本身。符*<sub>*符*</sub> 恰恰做到了这一点。*

*![$$ {U}^r\left|y\right\rangle ={U}^{r-1}\left| ay\ \left(\mathit{\operatorname{mod}}\ N\right)\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equy.png)*

*![$$ ={U}^{r-k}\left|{a}^ky\ \left(\mathit{\operatorname{mod}}\ N\right)\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equz.png)*

*![$$ =\left|{a}^ry\ \left(\mathit{\operatorname{mod}}\ N\right)\right\rangle =\left|y\ \right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ91.png)*
...
![$$ {U}_a\left|1\right\rangle =\left|a\ \mathit{\operatorname{mod}}\ N\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equaa.png)

![$$ {U}_a^2\left|1\right\rangle =\mid {a}^2\ \mathit{\operatorname{mod}}\ N\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equab.png)

...

![$$ {U}_a^{r-1}\left|1\right\rangle =\left|{a}^{r-1}\ \mathit{\operatorname{mod}}\ N\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equac.png)

![$$ {U}_a^r\left|1\right\rangle =\mid 1\ \Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ92.png)

(4-93)

图 [4-7](#Fig7) 是 *U* <sub>*a*</sub> 在状态∣1⟩上的应用示例，其中 *a* = 7， *N* = 15。在元素 *a mod N* 的情况下，周期 *r* 是 4。

![../images/495362_1_En_4_Chapter/495362_1_En_4_Fig7_HTML.jpg](../images/495362_1_En_4_Chapter/495362_1_En_4_Fig7_HTML.jpg)
...
![$$ \left|u\right\rangle =\frac{1}{\sqrt{r}\kern0.5em }\sum \limits_{k=0}^{r-1}\mid {a}^k\ \mathit{\operatorname{mod}}\ N\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ93.png)

(4-94)

不难看出，状态∣ *u* ⟩是一个特征向量 *U* <sub>*a*</sub> 。

![$$ {U}_a\left|u\right\rangle =\frac{1}{\sqrt{r}}{U}_a\left(\left|1\right\rangle +\left|a\ \mathit{\operatorname{mod}}\ N\right\rangle ..+\left|{a}^{r-1}\ \mathit{\operatorname{mod}}\ N\right\rangle \right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equad.png)

![$$ =\frac{1}{\sqrt{r}}\left(\mid a\ \mathit{\operatorname{mod}}\ N\right\rangle +\left|{a}^2\ \mathit{\operatorname{mod}}\ N\right\rangle ..+\left|{a}^r\ \mathit{\operatorname{mod}}\ N\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq62.png)

![$$ =\frac{1}{\sqrt{r}}\left(\left|a\ \mathit{\operatorname{mod}}\ N\right\rangle +\left|{a}^2\ \mathit{\operatorname{mod}}\ N\right\rangle ..+\left|1\right\rangle \right)=\mid u\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ94.png)

(4-95)

从方程 [4-95](#Equ94) 我们看到![$$ \left|u\right\rangle =\sum \limits_{k=0}^{r-1}\mid {a}^k\ \mathit{\operatorname{mod}}\ N\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq63.png)是 *U* <sub>* a *</sub> 的一个特征向量，但对我们来说并不有趣，因为它的特征值是 1，它的表达式中不包含周期 *r* 。

我们可以给每个计算基状态|*a*<sup>*k*</sup>*mod n*⟩添加一个相位，它们与 *k* 成比例并且包含周期 *r* ，如下所示:

![$$ \left|u\right\rangle =\frac{1}{\sqrt{r}\kern0.5em }\sum \limits_{k=0}^{r-1}{e}^{\frac{2\pi ik}{r}}\mid {a}^k\mathit{\operatorname{mod}}\ N\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ95.png)

(4-96)

让我们看看方程 [4-96](#Equ95) 中的∣ *u* ⟩是否仍然使其成为算子 *U* <sub>*a*</sub> 的特征向量。

![$$ {U}_a\left|u\right\rangle =\frac{1}{\sqrt{r}}{U}_a\left({e}^{\frac{2\pi i0}{r}}\left|1\right\rangle +{e}^{\frac{2\pi i1}{r}}\left|a\ \mathit{\operatorname{mod}}\ N\right\rangle ..+{e}^{\frac{2\pi i\left(r-1\right)}{r}}\left|{a}^{r-1}\ \mathit{\operatorname{mod}}\ N\right\rangle \right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equae.png)

![$$ =\frac{1}{\sqrt{r}}\left({e}^{\frac{2\pi i0}{r}}\mid a\ \mathit{\operatorname{mod}}\ N\right\rangle +{e}^{\frac{2\pi i1}{r}}\left|{a}^2\ \mathit{\operatorname{mod}}\ N\right\rangle ..+{e}^{\frac{2\pi i\left(r-1\right)}{r}}\left|{a}^r\ \mathit{\operatorname{mod}}\ N\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq64.png)

![$$ =\frac{1}{\sqrt{r}}{e}^{\frac{-2\pi i}{r}}\left({e}^{\frac{2\pi i1}{r}}\left|a\ \mathit{\operatorname{mod}}\ N\right\rangle +{e}^{\frac{2\pi i2}{r}}\left|{a}^2\ \mathit{\operatorname{mod}}\ N\right\rangle ..+{e}^{2\pi i}\left|1\right\rangle \right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equaf.png)

![$$ ={e}^{\frac{-2\pi i}{r}}\frac{1}{\sqrt{r}}\left({e}^{\frac{2\pi i1}{r}}\left|a\ \mathit{\operatorname{mod}}\ N\right\rangle +{e}^{\frac{2\pi i2}{r}}\left|{a}^2\ \mathit{\operatorname{mod}}\ N\right\rangle ..+\left|1\right\rangle \right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equag.png)

![$$ ={e}^{\frac{-2\pi i}{r}}\mid u\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ96.png)

(4-97)

我们可以看到，![$$ \left|u\right\rangle =\frac{1}{\sqrt{r}\ }\sum \limits_{k=0}^{r-1}{e}^{\frac{2\pi ik}{r}}\mid {a}^k\mathit{\operatorname{mod}}\ N\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq65.png)实际上是具有特征值![$$ {e}^{\frac{-2\pi i}{r}}. $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq66.png)的酉算子 *U* <sub>* a *</sub> 的特征向量，然而， *U* <sub>* a *</sub> 只是这样的一个特征向量。一般来说，我们可以将特征向量表示为:

![$$ \left|{u}_s\right\rangle =\frac{1}{\sqrt{r}\kern0.5em }\sum \limits_{k=0}^{r-1}{e}^{\frac{2\pi iks}{r}}\mid {a}^k\mathit{\operatorname{mod}}\ N\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ97.png)

(4-98)

在方程 [4-98](#Equ97) ， *s* ∈ {0，1，2。。*r*1 }因为对于 *s* ≥ *r* 的任何值，相位会重复自身，向量也是如此。∣*u*<sub>*s*</sub>⟩的相应特征值将为![$$ {e}^{\frac{-2\pi is}{r}} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq67.png)的形式。虽然在形式![$$ {e}^{\frac{-2\pi is}{r}} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq68.png)的本征值中存在相位，但是我们不能真正用|*u*<sub>*s*</sub>⟩进行量子相位估计，因为它包含未知周期 *r* 。你可能还记得，在量子傅立叶估计中，我们需要一个已知的特征向量∣*u*⟩。我们把特征向量∣*u*<sub>*s*</sub>⟩接下来定义的相等叠加，看看会不会有用？请注意，我们想要一个在开始量子相位估计之前完全已知的状态∣*u*⟩。

![$$ \left|u\right\rangle =\frac{1}{\sqrt{r}\kern0.5em }\sum \limits_{s=0}^{r-1}\mid {u}_s\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ98.png)

(4-99)

由方程 [4-98](#Equ97) 代入∣*u*T2】T3】st5】在方程 [4-99](#Equ98) 中，我们得到如下:

![$$ \left|u\right\rangle =\frac{1}{\sqrt{r}\kern0.5em }\sum \limits_{s=0}^{r-1}\frac{1}{\sqrt{r}\kern0.5em }\sum \limits_{k=0}^{r-1}{e}^{\frac{2\pi iks}{r}}\left|{a}^k\mathit{\operatorname{mod}}\ N\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equah.png)

![$$ =\frac{1}{r}\sum \limits_{s=0}^{r-1}\left({e}^{\frac{2\pi i0s}{r}}\left|{a}^0\mathit{\operatorname{mod}}\ N\right\rangle +{e}^{\frac{2\pi i1s}{r}}\left|{a}^1\mathit{\operatorname{mod}}\ N\right\rangle +..+{e}^{\frac{2\pi i\left(r-1\right)s}{r}}\left|{a}^{r-1}\mathit{\operatorname{mod}}\ N\right\rangle \right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equai.png)

![$$ =\frac{1}{r}\sum \limits_{s=0}^{r-1}\left(\left|1\right\rangle +{e}^{\frac{2\pi i1s}{r}}\left|{a}^1\mathit{\operatorname{mod}}\ N\right\rangle +..+{e}^{\frac{2\pi i\left(r-1\right)s}{r}}\left|{a}^{r-1}\mathit{\operatorname{mod}}\ N\right\rangle \right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ99.png)

![$$ =\left|1\right\rangle +\sum \limits_{s=0}^{r-1}{e}^{\frac{2\pi i1s}{r}}\left|a\ \mathit{\operatorname{mod}}\ N\right\rangle +\dots +\sum \limits_{s=0}^{r-1}{e}^{\frac{2\pi i\left(r-1\right)s}{r}}\left|{a}^{r-1}\mathit{\operatorname{mod}}\ N\right\rangle \Big) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equaj.png)

(4-100)

![$$ =\left|1\right\rangle +\sum \limits_{k=1}^{r-1}\mid {a}^k\mathit{\operatorname{mod}}\ N\Big\rangle \sum \limits_{s=0}^{r-1}{e}^{\frac{2\pi iks}{r}} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ100.png)

(4-101)

除了状态初态∣1⟩，各状态中的相位|*a*<sup>*k*</sup>*mod n*⟩是一个初项 *b* = 1，公比![$$ m={e}^{\frac{2\pi ik}{r}} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq69.png)的几何级数。 *k* ≥ 1 的各个值对应的几何级数和如下:

![$$ \sum \limits_{s=0}^{r-1}{e}^{\frac{2\pi ik s}{r}}=\frac{e^{\frac{2\pi ik}{r}}\left({e}^{\frac{2\pi ik.r}{r}}-1\right)}{e^{\frac{2\pi ik}{r}-1}}=\frac{e^{\frac{2\pi ik}{r}}\left({e}^{2\pi ik}-1\right)}{e^{\frac{2\pi ik}{r}-1}}=0 $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ101.png)

(4-102)

因此，状态![$$ \left|u\right\rangle =\frac{1}{\sqrt{r}\ }\sum \limits_{s=0}^{r-1}\mid {u}_s\left\rangle =\mid 1\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq70.png)，这对我们来说是好的，因为它是一个已知的向量，我们可以馈送给量子相位估计算法。由于∣ * u * ⟩是本征向量的叠加|*u*t5】0⟩，|*u*T9】1⟩，…∣*u*t13】t14】r1⟩用本征值![$$ 1,{e}^{\frac{-2\pi i}{r}},\dots ..,{e}^{\frac{-2\pi i\left(r-1\right)}{r}} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq71.png)代替量子相位估计，给出一个相位，就会给出所有本征向量对应的相位的叠加|*u*t20【0。∣*u*t28】t29】r1⟩.

因此，我们将在 QPE 的逆傅立叶变换阶段结束时得到的状态如下:

![$$ \left|\phi \right\rangle =\sum \limits_{s=0}^{r-1}\left|\frac{0}{r}\ \right\rangle +\mid \frac{1}{r}\ \left\rangle +\dots \mid \frac{1-r}{r}\ \right\rangle =\frac{1}{\sqrt{r}}\sum \limits_{s=0}^{r-1}\mid \frac{s}{r}\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ102.png)

(4-103)

现在在测量∣ *ϕ* ⟩时，我们将以相等的概率得到任何相位![$$ \frac{s}{r} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq72.png)，其中 *s* 是从 0 到(*r*1)的随机数。

我们知道相位的测量值![$$ \frac{s}{r} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq73.png)，其中 *s* ∈ {0，1，..r1 }是一个有理数。然而，我们将得到的相位![$$ \frac{s}{r} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq74.png)的值可能是一个实数，它是基于所定义的“第一寄存器”量子位的数量和由于舍入近似值的![$$ \frac{s}{r} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq75.png)的近似。我们可以使用连分数算法将实数转换成形式为![$$ \frac{b}{c} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq76.png)的有理数，其中 *b* 和 *c* 互为互质。我们知道![$$ \frac{r-1}{r} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq77.png)是测量相位中的最大值。因此，在对测得的最大相位应用连分数算法之后，如果我们可以得到两个整数 *b* 和 d *c* 使得*c*-*b*= 1，我们就可以确切地知道期望的周期 *r* = *c* 。

### 连分数算法

连分数算法是获得任意给定实数的有理数表示的有效方法。给定一个实数 *x* ，我们可以使用以下形式的表达式仅用整数来表示它:

![$$ x\approx \left[{b}_0,{b}_1,\dots {b}_m\right]={b}_o+\frac{1}{b_1+\frac{1}{\dots +{b}_m\ }} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ103.png)
...
*   *b*T2】1=![$$ integer\left(\frac{1}{r_0}\right)= integer\left(\frac{1}{0.67}\right)=1 $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq78.png)。剩余部分![$$ {r}_1=\frac{1}{{\mathrm{r}}_0}-{\mathrm{b}}_1=0.49257 $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq79.png)。

*   ![$$ {b}_2= integer\left(\frac{1}{r_1}\right)= integer\left(\frac{1}{0.49257}\right)=2 $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq80.png)。余数![$$ {r}_2=\frac{1}{r_1}-{b}_2=0.030168\. $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq81.png)

如果我们留下余数 *r* <sub>2</sub> ，0.67 的有理数近似值就是![$$ \frac{2}{3} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq82.png)，这里可以看到:

![$$ 0.67={b}_0+\frac{1}{b_1+\frac{1}{b_2\ }}=0+\frac{1}{1+\frac{1}{2}}=\frac{2}{3} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equak.png)

既然我们已经经历了将周期寻找问题转变为量子相位估计问题的相关试探法，我们将继续针对不同的值 *a* ≤ *N* 来实现它，其中我们选择 *N* = 15。图 [4-8](#Fig8) 显示了周期查找问题的高级示意图。

![../images/495362_1_En_4_Chapter/495362_1_En_4_Fig8_HTML.jpg](../images/495362_1_En_4_Chapter/495362_1_En_4_Fig8_HTML.jpg)
...
周期查找算法的核心是构建酉算子 *U* <sub>*a*</sub> ，这个我们已经通过`PeriodFinding`类中的`periodic_oracle`函数实现了。`periodic_oracle`函数使用一堆`SWAP`运算来实现酉运算*<sub>*a*</sub>。我们在代码的最后详细讨论了它的实现。我们之前已经确定 *a* 元素`that`是`N`的因子或者与`N`有共同的因子不会有`a^x mod N`形式的周期函数。一般来说，只有*和*元素`that`与`N`互质或互质，才会具有`a^x mod N`形式的周期函数。为了检查传递给程序的元素`a`是否与`N`互质，我们使用函数`euclid_gcd`返回`a`和`N`之间的最大公约数。周期性发现实现结束时的状态是状态![$$ \mid \frac{s}{r}\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq83.png)的相等叠加，其中`r`是周期，而 *s* ∈ {0，1，2。。，*r*—1 }。所以，在测量时，我们会从![$$ \frac{0}{r} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq84.png)、![$$ \frac{1}{r},\dots, \frac{r-1}{r} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq85.png)的均匀分布中得到其中一个状态。我们使用`measurement_to_period`函数得出最终周期。清单 [4-3](#PC10) 显示了周期查找算法的详细实现。*
...
![../images/495362_1_En_4_Chapter/495362_1_En_4_Fig9_HTML.jpg](../images/495362_1_En_4_Chapter/495362_1_En_4_Fig9_HTML.jpg)
...
![$$ {U}_2\mid y\left\rangle =\mid 2y\ \mathit{\operatorname{mod}}\ 15\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ104.png)
...
![$$ \left|y\right\rangle =\left|{y}_1,{y}_2,{y}_3,{y}_4\right\rangle =\mid 8{y}_1+4{y}_2+2{y}_3+{y}_4\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ105.png)

(4-106)

利用方程 [4-106](#Equ105) 中 *y* 的二进制展开，变换后的状态∣2 *y mod* 15 ⟩可以写成:

![$$ \left|2y\ \mathit{\operatorname{mod}}\ 15\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equal.png)

![$$ =\left|2\left(8{y}_1+4{y}_2+2{y}_3+{y}_4\right)\mathit{\operatorname{mod}}\ 15\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equam.png)

![$$ =\mid \left(16{y}_1+8{y}_2+4{y}_3+2{y}_4\right)\mathit{\operatorname{mod}}\ 15\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ106.png)

(4-107)

现在 16 *y* <sub>1</sub> mod 15 无非就是 *y* <sub>1</sub> 。其余项的最大值不会超过 15，因此我们可以将等式 [4-107](#Equ106) 改写如下:

![$$ \left|2y\ \mathit{\operatorname{mod}}\ 15\right\rangle =\mid {y}_1+8{y}_2+4{y}_3+2{y}_4\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ107.png)

(4-108)

等式 [4-108](#Equ107) 中等式右边的所有项都是 2 的幂的倍数。按照 2 的幂的降序排列，我们得到了:

![$$ \left|2y\ \mathit{\operatorname{mod}}\ 15\right\rangle =\mid 8{y}_2+4{y}_3+2{y}_4+{y}_1\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ108.png)
...
![$$ {U}_2\mid {y}_1,{y}_2,{y}_3,{y}_4\left\rangle =\mid {y}_2,{y}_3,{y}_4,{y}_1\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ110.png)

(4-111)

从方程 [4-111](#Equ110) 中，我们可以看到，所有幺正算符*U*T4】2 所做的就是互换四个量子位的状态。这可以通过在量子电路中使用交换运算符来有效实现，如图 [4-10](#Fig10) 所示。

![../images/495362_1_En_4_Chapter/495362_1_En_4_Fig10_HTML.jpg](../images/495362_1_En_4_Chapter/495362_1_En_4_Fig10_HTML.jpg)
...
![$$ {U}_{13}\mid y\left\rangle =\mid 13y\ \mathit{\operatorname{mod}}\ 15\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ111.png)

(4-112)

我们可以用(15-2)代替 13，将等式 [4-112](#Equ111) 改写如下:

![$$ {U}_{13}\left|y\right\rangle =\left|\left(15-2\right)y\ \mathit{\operatorname{mod}}\ 15\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equan.png)

![$$ =\left|\left(15y-2y\right)\mathit{\operatorname{mod}}\ 15\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equao.png)

![$$ =\mid -2y\ \mathit{\operatorname{mod}}\ 15\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ112.png)
...
![$$ {U}_{13}\left|y\right\rangle =\left|-2y\ \mathit{\operatorname{mod}}\ 15\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equap.png)

![$$ =\left|15-2y\ \mathit{\operatorname{mod}}\ 15\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equaq.png)

![$$ =\left|8+4+2+1-\left({y}_1+8{y}_2+4{y}_3+2{y}_4\right)\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equar.png)

![$$ =\left|8\left(1-{y}_2\right)+4\left(1-{y}_3\right)+2\left(1-{y}_4\right)+\left(1-{y}_1\right)\right\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equas.png)

![$$ =\mid 1-{y}_2,1-{y}_3,1-{y}_4,1-{y}_1\Big\rangle $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ113.png)
...
![../images/495362_1_En_4_Chapter/495362_1_En_4_Fig11_HTML.jpg](../images/495362_1_En_4_Chapter/495362_1_En_4_Fig11_HTML.jpg)
...
![$$ {x}^2\equiv 1\ \left(\mathit{\operatorname{mod}}\ N\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ115.png)

(4-116)

**属性二:**

![$$ x\ne \pm 1\ \left(\mathit{\operatorname{mod}}\ N\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ116.png)

(4-117)

现在让我们看看这样一个性质为 1 和 2 的数 *x* 如何帮助将 *N* 因式分解成素数 *p* 和 *q* 。从属性 1，我们有以下:

![$$ {x}^2\equiv 1\ \left(\mathit{\operatorname{mod}}\ N\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equat.png)

![$$ \to \kern0.75em {x}^2-1\equiv 0\ \left(\mathit{\operatorname{mod}}\ N\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equau.png)

![$$ \to \left(x-1\right)\left(x+1\right)\equiv \left(0\ \mathit{\operatorname{mod}}\ N\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ117.png)
...
![$$ p=\gcd \left(N,x+1\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equav.png)

![$$ q=\gcd \left(N,x-1\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ118.png)
...
![$$ {x}^2=4\equiv 4\ \mathit{\operatorname{mod}}\ 15 $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equaw.png)

![$$ x\equiv 2\ \mathit{\operatorname{mod}}\ 15\ne \pm 1\ \left(\mathit{\operatorname{mod}}\ 15\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ119.png)
...
![$$ {x}^2=16\equiv 1\ \left(\mathit{\operatorname{mod}}\ 15\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equax.png)

![$$ x=4\equiv 4\ \left(\mathit{\operatorname{mod}}\ 15\right)\ne \pm 1\ \left(\mathit{\operatorname{mod}}\ 15\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ120.png)

(4-121)

我们看到 *x* = 4 同时满足性质 1 和性质 2。因此，我们可以通过用( *x* + 1) = (4 + 1) = 5 和(*x*-1)=(4-1)= 3 计算 *N* 的最大公约数来找到两个素数 *p* 和 *q* 。

![$$ p=\gcd \left(N,x+1\right)=\left(15,5\right)=5 $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equay.png)

![$$ q=\gcd \left(N,x-1\right)=\left(15,3\right)=3 $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ121.png)
...
![$$ {a}^r\equiv 1\ \left(\mathit{\operatorname{mod}}\ N\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ122.png)
...
![$$ {a}^r\equiv 1\ \left(\mathit{\operatorname{mod}}\ N\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equaz.png)

![$$ \to {\left({a}^{\frac{r}{2}}\right)}^2\equiv 1\ \left(\mathit{\operatorname{mod}}\ N\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ123.png)

(4-124)

所以，当 *r* 为偶数时，满足性质 1。如果也满足![$$ {a}^{\frac{r}{2}}\ne 1\ \left(\mathit{\operatorname{mod}}\ N\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq86.png)，即属性 2 也满足，我们得到我们想要的![$$ ={a}^{\frac{r}{2}} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq87.png)。 *N* 的素因子可以找到如下:

![$$ p=\gcd \left(N,{a}^{\frac{r}{2}}+1\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equba.png)

![$$ q=\gcd \left(N,{a}^{\frac{r}{2}}-1\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ124.png)
...
如果周期 *r* 是奇数，属性 1 将不被满足，因为我们将不能获得![$$ {a}^{\frac{r}{2}} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq88.png)的整数值。在这种情况下，我们也应该尝试用不同的互质 *a* 相对于 *N* 来寻找周期。
...
`factoring`实现选择要因式分解的数字 *N* 的不同辅助因子 *a* ，并使用我们在上一节中实现的周期查找算法来得出形式为*f*<sub>*a*</sub>(*x*)=*a*<sup>*x*</sup>*modN*的函数的周期*对于每个这样的函数，*f*<sub>*a*</sub>(*x*)属于余因子，一旦确定了周期 *r* ，我们就检查![$$ {a}^{\frac{r}{2}} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq89.png)是否满足性质 1 和性质 2。如果两个性质都满足，我们得到两个因子![$$ \mathit{\gcd}\left(N,{a}^{\frac{r}{2}}+1\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq90.png)和![$$ \mathit{\gcd}\left(N,{a}^{\frac{r}{2}}-1\right). $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq91.png)如果两个性质都不满足，我们尝试用不同的辅助因子 *a* 。*
...
*   **身份**:存在一个元素 *e* ∈ *G* 如下:
    ...
    ![$$ a\circ e=e\circ a=a $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ125.png)

    (4-127)
*   **逆**:对于每个元素 *a* ∈ *G* 存在一个逆元素*a*T8】1 如下:

    ![$$ a\circ {a}^{-1}={a}^{-1}\circ a=e $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ126.png)

    (4-128)
*   **关联性**:对于任意三个元素 *a* 、 *b* 、 *c* ∈ *G* 以下成立:

    ![$$ \left(a\circ b\right)\circ c=a\circ \left(b\circ c\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ127.png)
...
![$$ AB\ne BA $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ128.png)

(4-130)

如果一个群( *G* ，◪)的元素按照合成法则交换，则称该群为阿贝尔群。因此，在一个阿贝尔群中，任何两个元素 *a* 、 *b* ∈ *G* 跟随其后。

![$$ a\circ b=b\circ a $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ129.png)
...
![$$ a\circ H=\left\{a\circ h\ \right|h\in H\Big\} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ130.png)
...
![$$ a\circ H=b\circ H\  if\ a=b\circ h\  for\ some\ h\in H $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ131.png)

(4-133)

现在让我们试着证明方程 [4-133](#Equ131) 中前面的说法。如果*a*∘*h*=*b*∘*h*，那么存在两个元素 *h* <sub>1</sub> 、*h*<sub>2</sub>∈*h*。

![$$ a\circ {h}_1=b\circ {h}_2 $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ132.png)

(4-134)

用方程 [4-134](#Equ132) 两边的![$$ {h}_1^{-1} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq92.png)进行运算，得到如下:

![$$ a\circ {h}_1\circ {h}_1^{-1}=b\circ {h}_2\circ {h}_1^{-1} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equbb.png)

![$$ \to a=b\circ \left({h}_2\circ {h}_1^{-1}\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ133.png)

(4-135)

从![$$ {h}_1,{h}_2,{h}_1^{-1}\in H $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq93.png)开始，根据一个组的闭包属性，元素![$$ h={h}_2\circ {h}_1^{-1}\in H $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq94.png)。因此，通过将![$$ \left({h}_2\circ {h}_1^{-1}\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_IEq95.png)替换为元素 *h* ∈ *H* ，我们得到如下:

![$$ a=b\circ {h}_2 $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ134.png)
...
![$$ \left(a\circ H=b\circ H=S\right)\to a,b\in S $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ135.png)
...
![$$ g\circ H=H\circ g\kern0.75em \forall g\in G $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ136.png)

(4-138)

用方程 [4-138](#Equ136) 两边的*g*T2 1 运算，我们得到这个:

![$$ H={g}^{-1}\circ H\circ g\kern0.75em \forall g\in G $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ137.png)
...
![$$ Q=\left\{g\circ H=H\circ g|g\in G\right\} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ138.png)

(4-140)

组 *Q* 的身份是陪集 *H* 本身，对于任意两个陪集 *a* ∘ *H* ，*b*∘*h*∈*q*闭包定义如下:

![$$ \left(a\circ H\right)\circ \left(b\circ H\right)=\left(a\circ b\right)\circ H $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ139.png)
...
![$$ \left(a\circ H\right)\circ \left(b\circ H\right)=a\circ H\circ b $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equbd.png)

![$$ =a\circ b\circ H $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ141.png)
...
*   *G*T6】1 中的标识元素 *e* <sub>1</sub> 映射到*G*T14】2 中的标识元素*e*T10】2；即*f*(*e*T20】1)=*e*T24】2。
    ...
    ![$$ f\left(x\circ {e}_1\right)=f(x)\ast f\left({e}_1\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Eqube.png)

    ![$$ \to f(x)=f(x)\ast f\left({e}_1\right)\kern1.75em \because x\circ {e}_1=x $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ143.png)
    ...
    ![$$ f\left({e}_1\right)={e}_2 $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ144.png)
...
*   Also, in group homomorphism, an inverse of an element in *G*<sub>1</sub> maps to an inverse in *G*<sub>2</sub>. To derive the expression for it, we can substitute *y* = *x*<sup>−1</sup> in Equation [4-144](#Equ142) and get this:
    ...
    ![$$ f\left(x\circ {x}^{-1}\ \right)=f(x)\ast f\left({x}^{-1}\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equbf.png)

    ![$$ \to f\left({e}_1\right)=f(x)\ast f\left({x}^{-1}\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equbg.png)

    ![$$ \to {e}_2=f(x)\ast f\left({x}^{-1}\right) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ145.png)
    ...
    ![$$ f\left({x}^{-1}\right)=\kern0.5em f{(x)}^{-1} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ146.png)
...
*   指数函数*f*(*x*)=*e*<sup>*x*</sup>定义了从群( *ℝ* ，+)到( *ℝ* > 0，×)的群同态。由于群( *ℝ* ，+)和( *ℝ* > 0，×)的合成法则分别是+和×，所以在这个例子中应该遵守的群同态性质如下:
    ...
    ![$$ f\left(x+y\right)=\kern0.5em f(x)\times f(y) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ147.png)

    (4-149) For the exponential function map *f*(*x*) = *e*<sup>*x*</sup>, this is obeyed since the following holds true:

    ![$$ {e}^{x+y}=\kern0.5em {e}^x\times {e}^y $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ148.png)

    (4-150)
*   行列式映射 det*GL*<sub>*n*</sub>(*ℝ*)→(*ℝ*<sub>≠0</sub>，×)其中*GL*<sub>*n*</sub>(*ℝ*)表示具有实项的一组 *n* × *n* 的可逆方阵这里要满足的同态规则如下:

    ![$$ f(AB)=\kern0.5em f(A)\times f(B) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ149.png)

    (4-151)

由于对于任意两个矩阵 *A* 和 *B* ，它们的行列式的乘积可以表示如下:

![$$ \mathit{\det}(AB)=\kern0.5em \mathit{\det}(A)\times \mathit{\det}(B) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ150.png)
...
*![$$ K=\left\{k\in G\right|f(k)={e}_2\Big\} $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ151.png)*
...
![$$ f\left({g}^{-1}\circ k\circ g\right)=f\left({g}^{-1}\right)\ast f(k)\ast f(g) $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equbh.png)

![$$ =f\left({g}^{-1}\right)\ast f(g)=f{(g)}^{-1}f(g)={e}_2 $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ152.png)
...
![../images/495362_1_En_4_Chapter/495362_1_En_4_Fig12_HTML.jpg](../images/495362_1_En_4_Chapter/495362_1_En_4_Fig12_HTML.jpg)
...
*![$$ f\left({g}_1\right)=f\left({g}_2\right)\  iff\kern0.5em {g}_1H={g}_2H $$](../images/495362_1_En_4_Chapter/495362_1_En_4_Chapter_TeX_Equ154.png)*
